...
public class VariableDeserializationTypeValidationTest {
  ...
  public void shouldValidateBaseTypeOnlyForComplexClass() {
    ...
    // then
    Mockito.verify(validator).validate("org.eximeebpms.bpm.engine.rest.sub.impl.VariableDeserializationTypeValidationTest$Complex");
    Mockito.verifyNoMoreInteractions(validator);
  }
  ...
  public void shouldFailForComplexClass() {
    ...
    // then
    thrown.expect(IllegalArgumentException.class);
    thrown.expectMessage("[org.eximeebpms.bpm.engine.rest.sub.impl.VariableDeserializationTypeValidationTest$Complex]");
