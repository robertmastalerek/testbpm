...
public interface TaskService {
  ...
  */
   ...
   *
   * <p>As of EximeeBPMS.4 task events are only written in context of a logged in
   ...
   *
   * @deprecated This method has been deprecated as of EximeeBPMS.1. It has been replaced with
