...
public class AbstractCmmnTransformListener implements CmmnTransformListener {
  ...
  public void transformCasePlanModel(org.eximeebpms.bpm.model.cmmn.impl.instance.CasePlanModel casePlanModel, CmmnActivity activity) {
    transformCasePlanModel((org.eximeebpms.bpm.model.cmmn.instance.CasePlanModel) casePlanModel, activity);
  }
