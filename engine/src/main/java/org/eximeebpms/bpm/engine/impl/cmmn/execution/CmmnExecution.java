 ...
 */
package org.eximeebpms.bpm.engine.impl.cmmn.execution;

import static org.eximeebpms.bpm.engine.impl.cmmn.execution.CaseExecutionState.ACTIVE;
import static org.eximeebpms.bpm.engine.impl.cmmn.execution.CaseExecutionState.AVAILABLE;
import static org.eximeebpms.bpm.engine.impl.cmmn.execution.CaseExecutionState.CLOSED;
import static org.eximeebpms.bpm.engine.impl.cmmn.execution.CaseExecutionState.COMPLETED;
...
import static org.eximeebpms.bpm.engine.impl.cmmn.execution.CaseExecutionState.FAILED;
import static org.eximeebpms.bpm.engine.impl.cmmn.execution.CaseExecutionState.NEW;
import static org.eximeebpms.bpm.engine.impl.cmmn.execution.CaseExecutionState.SUSPENDED;
import static org.eximeebpms.bpm.engine.impl.cmmn.execution.CaseExecutionState.SUSPENDING_ON_PARENT_SUSPENSION;
import static org.eximeebpms.bpm.engine.impl.cmmn.execution.CaseExecutionState.SUSPENDING_ON_SUSPENSION;
import static org.eximeebpms.bpm.engine.impl.cmmn.execution.CaseExecutionState.TERMINATED;
import static org.eximeebpms.bpm.engine.impl.cmmn.execution.CaseExecutionState.TERMINATING_ON_EXIT;
import static org.eximeebpms.bpm.engine.impl.cmmn.execution.CaseExecutionState.TERMINATING_ON_PARENT_TERMINATION;
import static org.eximeebpms.bpm.engine.impl.cmmn.execution.CaseExecutionState.TERMINATING_ON_TERMINATION;
import static org.eximeebpms.bpm.engine.impl.cmmn.model.CmmnSentryDeclaration.IF_PART;
import static org.eximeebpms.bpm.engine.impl.cmmn.model.CmmnSentryDeclaration.PLAN_ITEM_ON_PART;
import static org.eximeebpms.bpm.engine.impl.cmmn.model.CmmnSentryDeclaration.VARIABLE_ON_PART;
import static org.eximeebpms.bpm.engine.impl.cmmn.operation.CmmnAtomicOperation.CASE_EXECUTION_COMPLETE;
import static org.eximeebpms.bpm.engine.impl.cmmn.operation.CmmnAtomicOperation.CASE_EXECUTION_CREATE;
import static org.eximeebpms.bpm.engine.impl.cmmn.operation.CmmnAtomicOperation.CASE_EXECUTION_DELETE_CASCADE;
import static org.eximeebpms.bpm.engine.impl.cmmn.operation.CmmnAtomicOperation.CASE_EXECUTION_DISABLE;
import static org.eximeebpms.bpm.engine.impl.cmmn.operation.CmmnAtomicOperation.CASE_EXECUTION_ENABLE;
import static org.eximeebpms.bpm.engine.impl.cmmn.operation.CmmnAtomicOperation.CASE_EXECUTION_EXIT;
import static org.eximeebpms.bpm.engine.impl.cmmn.operation.CmmnAtomicOperation.CASE_EXECUTION_FIRE_ENTRY_CRITERIA;
import static org.eximeebpms.bpm.engine.impl.cmmn.operation.CmmnAtomicOperation.CASE_EXECUTION_FIRE_EXIT_CRITERIA;
import static org.eximeebpms.bpm.engine.impl.cmmn.operation.CmmnAtomicOperation.CASE_EXECUTION_MANUAL_COMPLETE;
import static org.eximeebpms.bpm.engine.impl.cmmn.operation.CmmnAtomicOperation.CASE_EXECUTION_MANUAL_START;
import static org.eximeebpms.bpm.engine.impl.cmmn.operation.CmmnAtomicOperation.CASE_EXECUTION_OCCUR;
import static org.eximeebpms.bpm.engine.impl.cmmn.operation.CmmnAtomicOperation.CASE_EXECUTION_PARENT_RESUME;
import static org.eximeebpms.bpm.engine.impl.cmmn.operation.CmmnAtomicOperation.CASE_EXECUTION_PARENT_SUSPEND;
import static org.eximeebpms.bpm.engine.impl.cmmn.operation.CmmnAtomicOperation.CASE_EXECUTION_PARENT_TERMINATE;
import static org.eximeebpms.bpm.engine.impl.cmmn.operation.CmmnAtomicOperation.CASE_EXECUTION_RESUME;
import static org.eximeebpms.bpm.engine.impl.cmmn.operation.CmmnAtomicOperation.CASE_EXECUTION_RE_ACTIVATE;
import static org.eximeebpms.bpm.engine.impl.cmmn.operation.CmmnAtomicOperation.CASE_EXECUTION_RE_ENABLE;
import static org.eximeebpms.bpm.engine.impl.cmmn.operation.CmmnAtomicOperation.CASE_EXECUTION_START;
import static org.eximeebpms.bpm.engine.impl.cmmn.operation.CmmnAtomicOperation.CASE_EXECUTION_SUSPEND;
import static org.eximeebpms.bpm.engine.impl.cmmn.operation.CmmnAtomicOperation.CASE_EXECUTION_SUSPENDING_ON_PARENT_SUSPENSION;
import static org.eximeebpms.bpm.engine.impl.cmmn.operation.CmmnAtomicOperation.CASE_EXECUTION_SUSPENDING_ON_SUSPENSION;
import static org.eximeebpms.bpm.engine.impl.cmmn.operation.CmmnAtomicOperation.CASE_EXECUTION_TERMINATE;
import static org.eximeebpms.bpm.engine.impl.cmmn.operation.CmmnAtomicOperation.CASE_EXECUTION_TERMINATING_ON_EXIT;
import static org.eximeebpms.bpm.engine.impl.cmmn.operation.CmmnAtomicOperation.CASE_EXECUTION_TERMINATING_ON_PARENT_TERMINATION;
import static org.eximeebpms.bpm.engine.impl.cmmn.operation.CmmnAtomicOperation.CASE_EXECUTION_TERMINATING_ON_TERMINATION;
import static org.eximeebpms.bpm.engine.impl.cmmn.operation.CmmnAtomicOperation.CASE_INSTANCE_CLOSE;
import static org.eximeebpms.bpm.engine.impl.cmmn.operation.CmmnAtomicOperation.CASE_INSTANCE_CREATE;
...
import org.eximeebpms.bpm.engine.impl.cmmn.model.CmmnIfPartDeclaration;
import org.eximeebpms.bpm.engine.impl.cmmn.model.CmmnOnPartDeclaration;
import org.eximeebpms.bpm.engine.impl.cmmn.model.CmmnSentryDeclaration;
import org.eximeebpms.bpm.engine.impl.cmmn.model.CmmnVariableOnPartDeclaration;
...
import org.eximeebpms.bpm.engine.impl.persistence.entity.TaskEntity.TaskState;
...
import org.eximeebpms.bpm.engine.impl.variable.listener.CaseVariableListenerInvocation;
import org.eximeebpms.bpm.engine.impl.variable.listener.DelegateCaseVariableInstanceImpl;
