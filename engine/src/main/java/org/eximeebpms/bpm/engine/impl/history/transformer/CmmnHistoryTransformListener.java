 ...
 */
package org.eximeebpms.bpm.engine.impl.history.transformer;
...
import org.eximeebpms.bpm.model.cmmn.instance.Milestone;
...
public class CmmnHistoryTransformListener implements CmmnTransformListener {
  ...
  public void transformCasePlanModel(org.eximeebpms.bpm.model.cmmn.impl.instance.CasePlanModel casePlanModel, CmmnActivity caseActivity) {
    transformCasePlanModel((org.eximeebpms.bpm.model.cmmn.instance.CasePlanModel) casePlanModel, caseActivity);
  }
