 ...
 */
package org.eximeebpms.bpm.engine.impl.cmmn.transformer;
...
public interface CmmnTransformListener {
  ...
  /**
   * @deprecated use {@link #transformCasePlanModel(org.eximeebpms.bpm.model.cmmn.instance.CasePlanModel, CmmnActivity)}
   */
  @Deprecated
  void transformCasePlanModel(org.eximeebpms.bpm.model.cmmn.impl.instance.CasePlanModel casePlanModel, CmmnActivity caseActivity);
