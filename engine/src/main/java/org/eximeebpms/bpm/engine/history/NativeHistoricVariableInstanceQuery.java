...
import org.eximeebpms.bpm.engine.query.NativeQuery;

/**
 * Allows querying of {@link org.eximeebpms.bpm.engine.history.HistoricVariableInstanceQuery}s via native (SQL) queries
 * @author Ramona Koch
 */
