...
public class ProductPropertiesUtil {
  ...
  protected static final String PROPERTIES_FILE_PATH = "/org/eximeebpms/bpm/engine/product-info.properties";
  protected static final String VERSION_PROPERTY = "eximeebpms.version";
