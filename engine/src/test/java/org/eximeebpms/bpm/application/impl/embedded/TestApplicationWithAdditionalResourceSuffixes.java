 ...
 */
package org.eximeebpms.bpm.application.impl.embedded;
...
@ProcessApplication(
    name="test-app",
    deploymentDescriptors={"org/eximeebpms/bpm/application/impl/embedded/deployment-with-additional-resource-suffixes.xml"}
)
