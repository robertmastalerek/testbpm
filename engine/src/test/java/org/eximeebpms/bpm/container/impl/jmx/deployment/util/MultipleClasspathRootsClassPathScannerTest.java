...
public class MultipleClasspathRootsClassPathScannerTest {
  ...
  public void testScanClassPath_multipleRoots() throws MalformedURLException {
    ...
    URLClassLoader classLoader = new URLClassLoader(
      new URL[]{
        new URL("file:src/test/resources/org/eximeebpms/bpm/container/impl/jmx/deployment/util/ClassPathScannerTest.testScanClassPathWithFiles/"),
        new URL("file:src/test/resources/org/eximeebpms/bpm/container/impl/jmx/deployment/util/ClassPathScannerTest.testScanClassPathWithFilesRecursive/"),
        new URL("file:src/test/resources/org/eximeebpms/bpm/container/impl/jmx/deployment/util/ClassPathScannerTest.testScanClassPathRecursiveTwoDirectories.jar")
      });
    ...
    scanResult.clear();
    scanner.scanPaResourceRootPath(classLoader, new URL("file:src/test/resources/org/eximeebpms/bpm/container/impl/jmx/deployment/util/ClassPathScannerTest.testScanClassPathWithFilesRecursive/META-INF/processes.xml"), "pa:directory/", scanResult);
