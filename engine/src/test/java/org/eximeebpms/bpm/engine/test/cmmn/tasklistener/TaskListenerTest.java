...
public class TaskListenerTest extends PluggableProcessEngineTest {
  ...
  @Deployment(resources = {
      "org/eximeebpms/bpm/engine/test/cmmn/tasklistener/TaskListenerTest.testListenerByScriptResource.cmmn",
      "org/eximeebpms/bpm/engine/test/cmmn/tasklistener/taskListener.groovy"
      })
  @Test
  ...
  public void testTaskListenerDoesNotExist() {
    ...
    try {
      ...
      Throwable cause = e.getCause();
      String message = cause.getMessage();
      testRule.assertTextPresent("Exception while instantiating class 'org.eximeebpms.bpm.engine.test.cmmn.tasklistener.util.NotExistingTaskListener'", message);
    }
