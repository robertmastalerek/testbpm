 ...
 */
package org.eximeebpms.bpm.engine.test.bpmn.receivetask;
...
public class ReceiveTaskTest extends PluggableProcessEngineTest {
  ...
  @Deployment(resources = "org/eximeebpms/bpm/engine/test/bpmn/receivetask/ReceiveTaskTest.simpleReceiveTask.bpmn20.xml")
  @Test
  ...
  @Deployment(resources = "org/eximeebpms/bpm/engine/test/bpmn/receivetask/ReceiveTaskTest.singleReceiveTask.bpmn20.xml")
  @Test
  ...
  @Deployment(resources = "org/eximeebpms/bpm/engine/test/bpmn/receivetask/ReceiveTaskTest.multiSequentialReceiveTask.bpmn20.xml")
  @Test
  ...
  @Deployment(resources = "org/eximeebpms/bpm/engine/test/bpmn/receivetask/ReceiveTaskTest.multiParallelReceiveTask.bpmn20.xml")
  @Test
  ...
  @Deployment(resources = "org/eximeebpms/bpm/engine/test/bpmn/receivetask/ReceiveTaskTest.multiParallelReceiveTaskCompensate.bpmn20.xml")
  @Test
  ...
  @Deployment(resources = "org/eximeebpms/bpm/engine/test/bpmn/receivetask/ReceiveTaskTest.multiParallelReceiveTaskBoundary.bpmn20.xml")
  @Test
  ...
  @Deployment(resources = "org/eximeebpms/bpm/engine/test/bpmn/receivetask/ReceiveTaskTest.subProcessReceiveTask.bpmn20.xml")
  @Test
  ...
  @Deployment(resources = "org/eximeebpms/bpm/engine/test/bpmn/receivetask/ReceiveTaskTest.multiSubProcessReceiveTask.bpmn20.xml")
  @Test
  ...
  @Deployment(resources = "org/eximeebpms/bpm/engine/test/bpmn/receivetask/ReceiveTaskTest.parallelGatewayReceiveTask.bpmn20.xml")
  @Test
