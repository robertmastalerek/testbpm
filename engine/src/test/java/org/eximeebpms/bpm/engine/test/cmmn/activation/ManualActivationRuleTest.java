 ...
 */
package org.eximeebpms.bpm.engine.test.cmmn.activation;
...
public class ManualActivationRuleTest extends PluggableProcessEngineTest {
   ...
   * CAM-3170
   */
  @Deployment(resources = "org/eximeebpms/bpm/engine/test/cmmn/activation/ManualActivationRuleTest.testVariableBasedRule.cmmn")
  @Test
  ...
  @Deployment(resources = "org/eximeebpms/bpm/engine/test/cmmn/activation/ManualActivationRuleTest.testDefaultVariableBasedRule.cmmn")
  @Test
  ...
  @Deployment(resources = "org/eximeebpms/bpm/engine/test/cmmn/activation/ManualActivationRuleTest.testActivationWithoutDefinition.cmmn")
  @Test
  ...
  @Deployment(resources = "org/eximeebpms/bpm/engine/test/cmmn/activation/ManualActivationRuleTest.testActivationWithoutManualActivationExpressionDefined.cmmn")
  @Test
  ...
  @Deployment(resources = "org/eximeebpms/bpm/engine/test/cmmn/activation/ManualActivationRuleTest.testActivationWithoutManualActivationConditionDefined.cmmn")
  @Test
