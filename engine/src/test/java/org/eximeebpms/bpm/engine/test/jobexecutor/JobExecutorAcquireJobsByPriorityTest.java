...
import static org.eximeebpms.bpm.engine.test.util.ClockTestUtil.incrementClock;
...
public class JobExecutorAcquireJobsByPriorityTest extends AbstractJobExecutorAcquireJobsTest {
  ...
  @Deployment(resources = {
    "org/eximeebpms/bpm/engine/test/jobexecutor/jobPrioProcess.bpmn20.xml",
    "org/eximeebpms/bpm/engine/test/jobexecutor/timerJobPrioProcess.bpmn20.xml"
  })
  ...
  @Test
  @Deployment(resources = "org/eximeebpms/bpm/engine/test/jobexecutor/jobPrioProcess.bpmn20.xml")
