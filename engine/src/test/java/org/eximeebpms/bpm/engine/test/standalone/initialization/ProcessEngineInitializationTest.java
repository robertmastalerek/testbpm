 ...
 */
package org.eximeebpms.bpm.engine.test.standalone.initialization;
...
public class ProcessEngineInitializationTest {
  ...
  public void testNoTables() {
    try {
      ...
      .createProcessEngineConfigurationFromResource("org/eximeebpms/bpm/engine/test/standalone/initialization/notables.eximeebpms.cfg.xml")
        .buildProcessEngine();
      ...
      assertThat(e.getMessage()).contains("ENGINE-03057 There are no Camunda tables in the database. " +
        ...
        "in eximeebpms.cfg.xml for automatic schema creation");
    }
  }
  ...
  public void testDefaultRetries() {
    ProcessEngineConfiguration configuration = ProcessEngineConfiguration
      .createProcessEngineConfigurationFromResource("org/eximeebpms/bpm/engine/test/standalone/initialization/defaultretries.eximeebpms.cfg.xml");
  ...
  public void testCustomDefaultRetries() {
    ProcessEngineConfiguration configuration = ProcessEngineConfiguration
      .createProcessEngineConfigurationFromResource("org/eximeebpms/bpm/engine/test/standalone/initialization/customdefaultretries.eximeebpms.cfg.xml");
