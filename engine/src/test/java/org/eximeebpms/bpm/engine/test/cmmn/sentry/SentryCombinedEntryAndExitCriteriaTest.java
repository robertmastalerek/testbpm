...
public class SentryCombinedEntryAndExitCriteriaTest extends CmmnTest {
  ...
  @Deployment(resources = {"org/eximeebpms/bpm/engine/test/cmmn/sentry/SentryCombinedEntryAndExitCriteriaTest.testParentResumeInsideStage.cmmn"})
  ...
  @Deployment(resources = {"org/eximeebpms/bpm/engine/test/cmmn/sentry/SentryCombinedEntryAndExitCriteriaTest.testParentSuspendInsideStage.cmmn"})
  ...
  @Deployment(resources = {"org/eximeebpms/bpm/engine/test/cmmn/sentry/SentryCombinedEntryAndExitCriteriaTest.testParentResumeInsideStageDifferentPlanItemOrder.cmmn"})
  ...
  @Deployment(resources = {"org/eximeebpms/bpm/engine/test/cmmn/sentry/SentryCombinedEntryAndExitCriteriaTest.testParentSuspendInsideStageDifferentPlanItemOrder.cmmn"})
