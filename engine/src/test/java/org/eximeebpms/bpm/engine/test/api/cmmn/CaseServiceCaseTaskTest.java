...
public class CaseServiceCaseTaskTest extends PluggableProcessEngineTest {
  ...
  @Deployment(resources={
      "org/eximeebpms/bpm/engine/test/api/cmmn/oneCaseTaskCase.cmmn",
      "org/eximeebpms/bpm/engine/test/api/cmmn/oneTaskCase.cmmn"
      })
  @Test
  ...
  @Deployment(resources={
      "org/eximeebpms/bpm/engine/test/api/cmmn/oneCaseTaskAndOneHumanTaskCaseWithManualActivation.cmmn",
      "org/eximeebpms/bpm/engine/test/api/cmmn/oneTaskCase.cmmn"
      })
  @Test
  ...
  @Deployment(resources={"org/eximeebpms/bpm/engine/test/api/cmmn/oneCaseTaskAndOneHumanTaskCaseWithManualActivation.cmmn"})
  @Test
  ...
  @Deployment(resources={"org/eximeebpms/bpm/engine/test/api/cmmn/oneCaseTaskCaseWithManualActivation.cmmn"})
  @Test
