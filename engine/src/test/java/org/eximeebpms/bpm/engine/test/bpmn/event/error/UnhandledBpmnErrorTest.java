...
public class UnhandledBpmnErrorTest {
  ...
  @Deployment(resources = {
      "org/eximeebpms/bpm/engine/test/bpmn/event/error/UnhandledBpmnErrorTest.testUncaughtErrorOnCallActivity.bpmn20.xml",
      "org/eximeebpms/bpm/engine/test/bpmn/event/error/UnhandledBpmnErrorTest.subprocess.bpmn20.xml" })
