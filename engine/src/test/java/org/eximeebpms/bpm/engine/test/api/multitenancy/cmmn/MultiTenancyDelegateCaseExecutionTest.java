...
import org.eximeebpms.bpm.engine.test.api.multitenancy.listener.AssertingCaseExecutionListener;
import org.eximeebpms.bpm.engine.test.api.multitenancy.listener.AssertingCaseExecutionListener.DelegateCaseExecutionAsserter;
...
public class MultiTenancyDelegateCaseExecutionTest extends PluggableProcessEngineTest {
  ...
  protected static final String HUMAN_TASK_CMMN_FILE = "org/eximeebpms/bpm/engine/test/api/multitenancy/HumanTaskCaseExecutionListener.cmmn";
  protected static final String CASE_TASK_CMMN_FILE = "org/eximeebpms/bpm/engine/test/api/multitenancy/CaseTaskCaseExecutionListener.cmmn";
  protected static final String CMMN_FILE = "org/eximeebpms/bpm/engine/test/api/cmmn/oneCaseTaskCaseWithManualActivation.cmmn";
