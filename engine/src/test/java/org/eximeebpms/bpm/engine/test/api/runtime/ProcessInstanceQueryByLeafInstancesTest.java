...
public class ProcessInstanceQueryByLeafInstancesTest {
  ...
  @Deployment(resources = { "org/eximeebpms/bpm/engine/test/api/runtime/superProcessWithNestedSubProcess.bpmn20.xml",
      "org/eximeebpms/bpm/engine/test/api/runtime/nestedSubProcess.bpmn20.xml", "org/eximeebpms/bpm/engine/test/api/runtime/subProcess.bpmn20.xml" })
  ...
  @Test
  @Deployment(resources = { "org/eximeebpms/bpm/engine/test/api/runtime/nestedSubProcess.bpmn20.xml",
  ...
  @Test
  @Deployment(resources = { "org/eximeebpms/bpm/engine/test/api/runtime/subProcess.bpmn20.xml" })
