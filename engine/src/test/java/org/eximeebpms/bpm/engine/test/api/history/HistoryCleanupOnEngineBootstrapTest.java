...
public class HistoryCleanupOnEngineBootstrapTest {
  ...
  public void testConsecutiveEngineBootstrapHistoryCleanupJobReconfiguration() {
    ...
    ProcessEngineConfiguration
      .createProcessEngineConfigurationFromResource("org/eximeebpms/bpm/engine/test/history/batchwindow.eximeebpms.cfg.xml")
      .buildProcessEngine()
      .close();
    ...
    ProcessEngineConfiguration
      .createProcessEngineConfigurationFromResource("org/eximeebpms/bpm/engine/test/history/no-batchwindow.eximeebpms.cfg.xml")
      .buildProcessEngine()
      .close();
  ...
  public void testDecreaseNumberOfHistoryCleanupJobs() {
    ...
    ProcessEngine engine = ProcessEngineConfiguration
      .createProcessEngineConfigurationFromResource("org/eximeebpms/bpm/engine/test/history/history-cleanup-parallelism-default.eximeebpms.cfg.xml")
      .buildProcessEngine();
    ...
    .createProcessEngineConfigurationFromResource("org/eximeebpms/bpm/engine/test/history/history-cleanup-parallelism-less.eximeebpms.cfg.xml")
      .buildProcessEngine();
  ...
  public void testIncreaseNumberOfHistoryCleanupJobs() {
    ...
    // when
    engine = ProcessEngineConfiguration
    .createProcessEngineConfigurationFromResource("org/eximeebpms/bpm/engine/test/history/history-cleanup-parallelism-more.eximeebpms.cfg.xml")
      .buildProcessEngine();
  ...
  public void testBatchWindowXmlConfigParsingException() throws ParseException {
    ...
    assertThatThrownBy(() -> ProcessEngineConfiguration
      .createProcessEngineConfigurationFromResource("org/eximeebpms/bpm/engine/test/history/history-cleanup-batch-window-map-wrong-values.eximeebpms.cfg.xml")
      .buildProcessEngine())
  ...
  public void testBatchWindowMapInXmlConfig() throws ParseException {
    ...
    ProcessEngine engine = ProcessEngineConfiguration
      .createProcessEngineConfigurationFromResource("org/eximeebpms/bpm/engine/test/history/history-cleanup-batch-window-map.eximeebpms.cfg.xml")
      .buildProcessEngine();
    ...
    engine = ProcessEngineConfiguration
      .createProcessEngineConfigurationFromResource("org/eximeebpms/bpm/engine/test/history/history-cleanup-batch-window-default.eximeebpms.cfg.xml")
      .buildProcessEngine();
  ...
  public void testHistoryCleanupJobScheduled() throws ParseException {
    ...
    standaloneInMemProcessEngineConfiguration.setJdbcUrl("jdbc:h2:mem:eximeebpms" + getClass().getSimpleName() + "testHistoryCleanupJobScheduled");
  ...
  public void shouldCreateHistoryCleanupJobLogs() {
    ...
    standaloneInMemProcessEngineConfiguration
        .setJdbcUrl("jdbc:h2:mem:eximeebpms" + getClass().getSimpleName() + "testHistoryCleanupJobScheduled");
  ...
  public void testBatchWindowOneDayOfWeek() throws ParseException {
    ...
    configuration.setJdbcUrl("jdbc:h2:mem:eximeebpms" + getClass().getSimpleName() + "testBatchWindowOneDayOfWeek");
  ...
  public void testBatchWindow24Hours() throws ParseException {
    ...
    configuration.setJdbcUrl("jdbc:h2:mem:eximeebpms" + getClass().getSimpleName() + "testBatchWindow24Hours");
