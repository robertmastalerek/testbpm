...
import static org.eximeebpms.bpm.engine.test.standalone.deploy.TestCmmnTransformListener.numberOfRegistered;
...
public class CmmnTransformListenerTest {
  ...
  public static ProcessEngineBootstrapRule bootstrapRule = new ProcessEngineBootstrapRule(
      "org/eximeebpms/bpm/engine/test/standalone/deploy/cmmn.transform.listener.eximeebpms.cfg.xml");
  @Rule
