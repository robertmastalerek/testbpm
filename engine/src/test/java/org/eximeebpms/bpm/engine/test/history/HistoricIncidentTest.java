...
public class HistoricIncidentTest extends PluggableProcessEngineTest {
  ...
  @Deployment(resources={"org/eximeebpms/bpm/engine/test/history/HistoricIncidentQueryTest.testQueryByCauseIncidentId.bpmn20.xml",
  "org/eximeebpms/bpm/engine/test/api/runtime/oneFailingServiceProcess.bpmn20.xml"})
  @Test
  ...
  @Deployment(resources={"org/eximeebpms/bpm/engine/test/history/HistoricIncidentTest.testCreateRecursiveHistoricIncidentsForNestedCallActivities.bpmn20.xml",
      "org/eximeebpms/bpm/engine/test/history/HistoricIncidentQueryTest.testQueryByCauseIncidentId.bpmn20.xml",
      "org/eximeebpms/bpm/engine/test/api/runtime/oneFailingServiceProcess.bpmn20.xml"})
  @Test
