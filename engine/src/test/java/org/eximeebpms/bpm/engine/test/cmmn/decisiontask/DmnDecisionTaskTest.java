 ...
 */
package org.eximeebpms.bpm.engine.test.cmmn.decisiontask;
...
public class DmnDecisionTaskTest extends CmmnTest {
  ...
  public static final String CMMN_CALL_DECISION_CONSTANT = "org/eximeebpms/bpm/engine/test/cmmn/decisiontask/DmnDecisionTaskTest.testCallDecisionAsConstant.cmmn";
  public static final String CMMN_CALL_DECISION_CONSTANT_WITH_MANUAL_ACTIVATION = "org/eximeebpms/bpm/engine/test/cmmn/decisiontask/DmnDecisionTaskTest.testCallDecisionAsConstantWithManualActiovation.cmmn";
  public static final String CMMN_CALL_DECISION_EXPRESSION = "org/eximeebpms/bpm/engine/test/cmmn/decisiontask/DmnDecisionTaskTest.testCallDecisionAsExpressionStartsWithDollar.cmmn";
  public static final String CMMN_CALL_DECISION_EXPRESSION_WITH_MANUAL_ACTIVATION = "org/eximeebpms/bpm/engine/test/cmmn/decisiontask/DmnDecisionTaskTest.testCallDecisionAsExpressionStartsWithDollarWithManualActiovation.cmmn";

  public static final String DECISION_OKAY_DMN = "org/eximeebpms/bpm/engine/test/cmmn/decisiontask/DmnDecisionTaskTest.testDecisionOkay.dmn11.xml";
  public static final String DECISION_NOT_OKAY_DMN = "org/eximeebpms/bpm/engine/test/cmmn/decisiontask/DmnDecisionTaskTest.testDecisionNotOkay.dmn11.xml";
  public static final String DECISION_POJO_DMN = "org/eximeebpms/bpm/engine/test/cmmn/decisiontask/DmnDecisionTaskTest.testPojo.dmn11.xml";
  ...
  @Deployment(resources = {
      "org/eximeebpms/bpm/engine/test/cmmn/decisiontask/DmnDecisionTaskTest.testCallDecisionAsExpressionStartsWithHash.cmmn",
      DECISION_OKAY_DMN
    })
  @Test
  ...
  @Deployment(resources = {
      "org/eximeebpms/bpm/engine/test/cmmn/decisiontask/DmnDecisionTaskTest.testCallLatestDecision.cmmn",
      DECISION_OKAY_DMN
    })
  @Test
  ...
  @Deployment(resources = {
      "org/eximeebpms/bpm/engine/test/cmmn/decisiontask/DmnDecisionTaskTest.testCallDecisionByDeployment.cmmn",
      DECISION_OKAY_DMN
    })
  @Test
  ...
  @Deployment(resources = {
      "org/eximeebpms/bpm/engine/test/cmmn/decisiontask/DmnDecisionTaskTest.testCallDecisionByVersion.cmmn",
      DECISION_OKAY_DMN
    })
  @Test
  ...
  @Deployment(resources = {
      "org/eximeebpms/bpm/engine/test/cmmn/decisiontask/DmnDecisionTaskTest.testCallDecisionByVersionAsExpressionStartsWithDollar.cmmn",
      DECISION_OKAY_DMN
    })
  @Test
  ...
  @Deployment(resources = {
      "org/eximeebpms/bpm/engine/test/cmmn/decisiontask/DmnDecisionTaskTest.testCallDecisionByVersionAsExpressionStartsWithHash.cmmn",
      DECISION_OKAY_DMN
    })
  @Test
