...
public class HistoricActivityInstanceStateTest extends PluggableProcessEngineTest {
  ...
  @Deployment (resources={ "org/eximeebpms/bpm/engine/test/history/HistoricActivityInstanceStateTest.testCancelProcessInstanceInUserTask.bpmn",
      "org/eximeebpms/bpm/engine/test/history/HistoricActivityInstanceStateTest.testEndTerminateEventWithCallActivity.bpmn" })
  @Test
