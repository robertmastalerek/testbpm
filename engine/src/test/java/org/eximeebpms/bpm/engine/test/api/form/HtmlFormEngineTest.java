...
import org.eximeebpms.bpm.engine.impl.form.engine.HtmlDocumentBuilder;
import org.eximeebpms.bpm.engine.impl.form.engine.HtmlElementWriter;
...
public class HtmlFormEngineTest extends PluggableProcessEngineTest {
  ...
  public void testRenderStartForm() {
    ...
    String expectedForm = IoUtil.readClasspathResourceAsString("org/eximeebpms/bpm/engine/test/api/form/HtmlFormEngineTest.testRenderStartForm.html");
  ...
  public void testRenderEnumField() {
    ...
    String expectedForm = IoUtil.readClasspathResourceAsString("org/eximeebpms/bpm/engine/test/api/form/HtmlFormEngineTest.testRenderEnumField.html");
  ...
  public void testRenderTaskForm() {
    ...
    String expectedForm = IoUtil.readClasspathResourceAsString("org/eximeebpms/bpm/engine/test/api/form/HtmlFormEngineTest.testRenderTaskForm.html");
  ...
  public void testRenderDateField() {
    ...
    String expectedForm = IoUtil.readClasspathResourceAsString("org/eximeebpms/bpm/engine/test/api/form/HtmlFormEngineTest.testRenderDateField.html");
  ...
  public void testRenderDateFieldWithPattern() {
    ...
    String expectedForm = IoUtil.readClasspathResourceAsString("org/eximeebpms/bpm/engine/test/api/form/HtmlFormEngineTest.testRenderDateFieldWithPattern.html");
  ...
  public void testLegacyFormPropertySupport() {
    ...
    String expectedForm = IoUtil.readClasspathResourceAsString("org/eximeebpms/bpm/engine/test/api/form/HtmlFormEngineTest.testLegacyFormPropertySupport.html");
  ...
  public void testLegacyFormPropertySupportReadOnly() {
    ...
    String expectedForm = IoUtil.readClasspathResourceAsString("org/eximeebpms/bpm/engine/test/api/form/HtmlFormEngineTest.testLegacyFormPropertySupportReadOnly.html");
  ...
  public void testLegacyFormPropertySupportRequired() {
    ...
    String expectedForm = IoUtil.readClasspathResourceAsString("org/eximeebpms/bpm/engine/test/api/form/HtmlFormEngineTest.testLegacyFormPropertySupportRequired.html");
  ...
  public void testBusinessKey() {
    ...
    String expectedForm = IoUtil.readClasspathResourceAsString("org/eximeebpms/bpm/engine/test/api/form/HtmlFormEngineTest.testBusinessKey.html");
