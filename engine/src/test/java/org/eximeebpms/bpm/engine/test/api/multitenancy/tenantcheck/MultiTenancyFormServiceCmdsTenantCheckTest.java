 ...
 protected static final String TENANT_ONE = "tenant1";
  ...
  public void testGetStartFormWithAuthenticatedTenant() {
    ...
    testRule.deployForTenant(TENANT_ONE,
      "org/eximeebpms/bpm/engine/test/api/authorization/formKeyProcess.bpmn20.xml");
  ...
  public void testGetStartFormKeyWithAuthenticatedTenant() {
    ...
    testRule.deployForTenant(TENANT_ONE, "org/eximeebpms/bpm/engine/test/api/authorization/formKeyProcess.bpmn20.xml");
  ...
  public void testGetRenderedTaskFormWithAuthenticatedTenant() {
    ...
    // deploy tenants
    testRule.deployForTenant(TENANT_ONE,
      "org/eximeebpms/bpm/engine/test/api/form/FormsProcess.bpmn20.xml",
      "org/eximeebpms/bpm/engine/test/api/form/task.html").getId();
