...
public class CaseServiceStageTest extends PluggableProcessEngineTest {
  ...
  @Deployment(resources={"org/eximeebpms/bpm/engine/test/api/cmmn/oneStageCase.cmmn"})
  @Test
  ...
  @Deployment(resources={"org/eximeebpms/bpm/engine/test/api/cmmn/oneStageCaseWithManualActivation.cmmn"})
  @Test
  ...
  @Deployment(resources={"org/eximeebpms/bpm/engine/test/api/cmmn/oneTaskAndOneStageCase.cmmn"})
  @Test
  ...
  @Deployment(resources={"org/eximeebpms/bpm/engine/test/api/cmmn/emptyStageCase.cmmn"})
  @Test
