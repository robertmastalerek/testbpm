...
import static org.eximeebpms.bpm.engine.test.util.TypedValueAssert.assertObjectValueSerializedJava;
...
public class ProcessInstantiationWithVariablesInReturnTest {
  ...
  protected static final String SET_VARIABLE_IN_DELEGATE_PROCESS = "org/eximeebpms/bpm/engine/test/api/runtime/ProcessInstantiationWithVariablesInReturn.setVariableInDelegate.bpmn20.xml";
  protected static final String SET_VARIABLE_IN_DELEGATE_WITH_WAIT_STATE_PROCESS = "org/eximeebpms/bpm/engine/test/api/runtime/ProcessInstantiationWithVariablesInReturn.setVariableInDelegateWithWaitState.bpmn20.xml";
  protected static final String SIMPLE_PROCESS = "org/eximeebpms/bpm/engine/test/api/runtime/ProcessInstantiationWithVariablesInReturn.simpleProcess.bpmn20.xml";
