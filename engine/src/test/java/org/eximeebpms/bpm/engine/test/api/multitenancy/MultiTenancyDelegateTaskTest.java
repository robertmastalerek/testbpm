...
import org.eximeebpms.bpm.engine.test.api.delegate.AssertingTaskListener;
import org.eximeebpms.bpm.engine.test.api.delegate.AssertingTaskListener.DelegateTaskAsserter;
...
public class MultiTenancyDelegateTaskTest extends PluggableProcessEngineTest {
  ...
  protected static final String BPMN = "org/eximeebpms/bpm/engine/test/api/multitenancy/taskListener.bpmn";
