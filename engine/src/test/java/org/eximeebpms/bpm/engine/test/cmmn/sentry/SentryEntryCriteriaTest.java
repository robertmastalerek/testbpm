...
import org.eximeebpms.bpm.engine.impl.cmmn.execution.CmmnSentryPart;
...
public class SentryEntryCriteriaTest extends CmmnTest {
  ...
  @Deployment(resources = {"org/eximeebpms/bpm/engine/test/cmmn/sentry/SentryEntryCriteriaTest.testSequenceEnableTask.cmmn"})
  @Test
  ...
  @Deployment(resources = {"org/eximeebpms/bpm/engine/test/cmmn/sentry/SentryEntryCriteriaTest.testSequenceAutoStartTask.cmmn"})
  @Test
  ...
  @Deployment(resources = {"org/eximeebpms/bpm/engine/test/cmmn/sentry/SentryEntryCriteriaTest.testSequenceEnableStage.cmmn"})
  @Test
  ...
  @Deployment(resources = {"org/eximeebpms/bpm/engine/test/cmmn/sentry/SentryEntryCriteriaTest.testSequenceAutoStartStage.cmmn"})
  @Test
  ...
  @Deployment(resources = {"org/eximeebpms/bpm/engine/test/cmmn/sentry/SentryEntryCriteriaTest.testSequenceOccurMilestone.cmmn"})
  @Test
  ...
  @Deployment(resources = {"org/eximeebpms/bpm/engine/test/cmmn/sentry/SentryEntryCriteriaTest.testSequence.cmmn"})
  @Test
  ...
  @Deployment(resources = {"org/eximeebpms/bpm/engine/test/cmmn/sentry/SentryEntryCriteriaTest.testSequenceWithIfPart.cmmn"})
  @Test
  ...
  @Deployment(resources = {"org/eximeebpms/bpm/engine/test/cmmn/sentry/SentryEntryCriteriaTest.testAndFork.cmmn"})
  @Test
  ...
  @Deployment(resources = {"org/eximeebpms/bpm/engine/test/cmmn/sentry/SentryEntryCriteriaTest.testAndJoin.cmmn"})
  @Test
  ...
  @Deployment(resources = {"org/eximeebpms/bpm/engine/test/cmmn/sentry/SentryEntryCriteriaTest.testSequenceCombinedWithAndJoin.cmmn"})
  @Test
  ...
  @Deployment(resources = {"org/eximeebpms/bpm/engine/test/cmmn/sentry/SentryEntryCriteriaTest.testOrFork.cmmn"})
  @Test
  ...
  @Deployment(resources = {"org/eximeebpms/bpm/engine/test/cmmn/sentry/SentryEntryCriteriaTest.testOrJoin.cmmn"})
  @Test
  ...
  @Deployment(resources = {"org/eximeebpms/bpm/engine/test/cmmn/sentry/SentryEntryCriteriaTest.testCycle.cmmn"})
  @Test
  ...
  @Deployment(resources = {"org/eximeebpms/bpm/engine/test/cmmn/sentry/SentryEntryCriteriaTest.testEnableByInstanceCreation.cmmn"})
  @Test
  ...
  @Deployment(resources = {"org/eximeebpms/bpm/engine/test/cmmn/sentry/SentryEntryCriteriaTest.testEnableOnParentSuspendInsideStage.cmmn"})
  ...
  @Deployment(resources = {"org/eximeebpms/bpm/engine/test/cmmn/sentry/SentryEntryCriteriaTest.testEnableOnParentResumeInsideStage.cmmn"})
   ...
   * will be suspended.
   */
  @Deployment(resources = {"org/eximeebpms/bpm/engine/test/cmmn/sentry/SentryEntryCriteriaTest.testResume.cmmn"})
  ...
  @Deployment(resources = {"org/eximeebpms/bpm/engine/test/cmmn/sentry/SentryEntryCriteriaTest.testFireAlsoNotAffectedSentries.cmmn"})
  @Test
  ...
  @Deployment(resources = {
      "org/eximeebpms/bpm/engine/test/cmmn/sentry/SentryEntryCriteriaTest.testShouldNotTriggerCompletionTwice.cmmn",
      "org/eximeebpms/bpm/engine/test/cmmn/sentry/SentryEntryCriteriaTest.noop.bpmn20.xml"
  })
  @Test
