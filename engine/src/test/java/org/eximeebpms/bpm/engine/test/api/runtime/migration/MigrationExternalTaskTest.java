...
import static org.eximeebpms.bpm.engine.test.util.MigrationPlanValidationReportAssert.assertThat;
...
public class MigrationExternalTaskTest {
  ...
  public void testProcessDefinitionWithoutIdField() {
    ...
    ProcessDefinition sourceProcessDefinition = testHelper.deploy("org/eximeebpms/bpm/engine/test/api/externaltask/ExternalTaskWithoutIdTest.bpmn").getDeployedProcessDefinitions().get(0);
    ProcessDefinition targetProcessDefinition = testHelper.deploy("org/eximeebpms/bpm/engine/test/api/externaltask/ExternalTaskWithoutIdTest.bpmn").getDeployedProcessDefinitions().get(0);
  ...
  public void testProcessDefinitionWithIdField() {
    ...
    ProcessDefinition sourceProcessDefinition = testHelper.deploy("org/eximeebpms/bpm/engine/test/api/externaltask/ExternalTaskWithIdTest.bpmn").getDeployedProcessDefinitions().get(0);
    ProcessDefinition targetProcessDefinition = testHelper.deploy("org/eximeebpms/bpm/engine/test/api/externaltask/ExternalTaskWithIdTest.bpmn").getDeployedProcessDefinitions().get(0);
