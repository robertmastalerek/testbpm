...
public class ProcessDefinitionStatisticsQueryTest extends PluggableProcessEngineTest {
  ...
  public void testProcessDefinitionStatisticsQueryForMultipleVersions() {
    org.eximeebpms.bpm.engine.repository.Deployment deployment =
        repositoryService.createDeployment()
          .addClasspathResource("org/eximeebpms/bpm/engine/test/api/mgmt/StatisticsTest.testStatisticsQueryWithFailedJobs.bpmn20.xml")
          .deploy();
  ...
  public void testProcessDefinitionStatisticsQueryPagination() {
    org.eximeebpms.bpm.engine.repository.Deployment deployment =
        repositoryService.createDeployment()
          .addClasspathResource("org/eximeebpms/bpm/engine/test/api/mgmt/StatisticsTest.testStatisticsQuery.bpmn20.xml")
          .deploy();
