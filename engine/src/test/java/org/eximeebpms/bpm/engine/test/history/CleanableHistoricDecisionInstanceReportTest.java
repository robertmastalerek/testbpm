...
public class CleanableHistoricDecisionInstanceReportTest {
  ...
  public void setUp() {
    ...
    testRule.deploy("org/eximeebpms/bpm/engine/test/repository/one.dmn");
  }
  ...
  public void testReportComplex() {
    // given
    testRule.deploy("org/eximeebpms/bpm/engine/test/repository/two.dmn", "org/eximeebpms/bpm/engine/test/api/dmn/Another_Example.dmn",
        "org/eximeebpms/bpm/engine/test/api/dmn/Example.dmn");
