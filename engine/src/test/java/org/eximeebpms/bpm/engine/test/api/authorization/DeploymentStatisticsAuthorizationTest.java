...
public class DeploymentStatisticsAuthorizationTest extends AuthorizationTest {
  ...
  public void setUp() throws Exception {
    firstDeploymentId = createDeployment("first", "org/eximeebpms/bpm/engine/test/api/authorization/oneIncidentProcess.bpmn20.xml").getId();
    secondDeploymentId = createDeployment("second", "org/eximeebpms/bpm/engine/test/api/authorization/timerStartEventProcess.bpmn20.xml").getId();
    thirdDeploymentId = createDeployment("third", "org/eximeebpms/bpm/engine/test/api/authorization/timerBoundaryEventProcess.bpmn20.xml").getId();
    super.setUp();
  }
