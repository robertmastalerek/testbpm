...
import static org.eximeebpms.bpm.engine.impl.bpmn.parser.DefaultFailedJobParseListener.FAILED_JOB_CONFIGURATION;
...
public class FoxFailedJobParseListenerTest extends PluggableProcessEngineTest {
  ...
  @Deployment(resources = { "org/eximeebpms/bpm/engine/test/bpmn/parse/FoxFailedJobParseListenerTest.testUserTask.bpmn20.xml" })
  @Test
  ...
  @Deployment(resources = { "org/eximeebpms/bpm/engine/test/bpmn/parse/FoxFailedJobParseListenerTest.testTimer.bpmn20.xml" })
  @Test
  ...
  @Deployment(resources = { "org/eximeebpms/bpm/engine/test/bpmn/parse/FoxFailedJobParseListenerTest.testSignal.bpmn20.xml" })
  @Test
