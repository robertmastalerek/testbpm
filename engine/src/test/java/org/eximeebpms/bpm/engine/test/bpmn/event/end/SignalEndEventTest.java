...
public class SignalEndEventTest extends PluggableProcessEngineTest {
  ...
  @Deployment(resources={
      "org/eximeebpms/bpm/engine/test/bpmn/event/end/SignalEndEventTest.catchSignalEndEvent.bpmn20.xml",
      "org/eximeebpms/bpm/engine/test/bpmn/event/end/SignalEndEventTest.processWithSignalEndEvent.bpmn20.xml"
    })
  @Test
  ...
  @Deployment(resources = { "org/eximeebpms/bpm/engine/test/bpmn/event/signal/testPropagateOutputVariablesWhileThrowSignal.bpmn20.xml",
                            "org/eximeebpms/bpm/engine/test/bpmn/event/signal/SignalEndEventTest.parent.bpmn20.xml" })
  @Test
  ...
  @Deployment(resources = { "org/eximeebpms/bpm/engine/test/bpmn/event/signal/testPropagateOutputVariablesWhileThrowSignal2.bpmn20.xml",
                            "org/eximeebpms/bpm/engine/test/bpmn/event/signal/SignalEndEventTest.parent.bpmn20.xml" })
  @Test
