...
public class PvmEventTest {
  ...
  public void testStartEndEvents() {
    ...
    PvmProcessDefinition processDefinition = new ProcessDefinitionBuilder("events")
      .executionListener(org.eximeebpms.bpm.engine.impl.pvm.PvmEvent.EVENTNAME_START, eventCollector)
      .executionListener(org.eximeebpms.bpm.engine.impl.pvm.PvmEvent.EVENTNAME_END, eventCollector)
