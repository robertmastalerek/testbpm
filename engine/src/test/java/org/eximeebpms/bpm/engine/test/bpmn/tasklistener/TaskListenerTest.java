 ...
 */
package org.eximeebpms.bpm.engine.test.bpmn.tasklistener;
...
import org.eximeebpms.bpm.engine.test.bpmn.tasklistener.util.CompletingTaskListener;
import org.eximeebpms.bpm.engine.test.bpmn.tasklistener.util.RecorderTaskListener;
import org.eximeebpms.bpm.engine.test.bpmn.tasklistener.util.RecorderTaskListener.RecordedTaskEvent;
import org.eximeebpms.bpm.engine.test.bpmn.tasklistener.util.TaskDeleteListener;
...
public class TaskListenerTest extends AbstractTaskListenerTest {
  ...
  @Test
  @Deployment(resources = {"org/eximeebpms/bpm/engine/test/bpmn/tasklistener/TaskListenerTest.bpmn20.xml"})
  ...
  @Deployment(resources = {
    "org/eximeebpms/bpm/engine/test/bpmn/tasklistener/TaskListenerTest.testScriptResourceListener.bpmn20.xml",
    "org/eximeebpms/bpm/engine/test/bpmn/tasklistener/taskListener.groovy"
  })
  ...
  @Test
  @Deployment(resources = "org/eximeebpms/bpm/engine/test/bpmn/tasklistener/TaskListenerTest.testTimeoutTaskListenerDuration.bpmn20.xml")
  ...
  @Test
  @Deployment(resources = "org/eximeebpms/bpm/engine/test/bpmn/tasklistener/TaskListenerTest.testRecalculateTimeoutTaskListenerDuedateCreationDateBased.bpmn20.xml")
