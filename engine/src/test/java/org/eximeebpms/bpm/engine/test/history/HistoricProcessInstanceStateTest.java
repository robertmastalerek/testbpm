...
import org.eximeebpms.bpm.model.bpmn.instance.TerminateEventDefinition;
...
public class HistoricProcessInstanceStateTest {
  ...
  @Test
  @Deployment(resources = {"org/eximeebpms/bpm/engine/test/history/HistoricProcessInstanceStateTest.testWithCallActivity.bpmn"})
  ...
  @Test
  @Deployment(resources = {"org/eximeebpms/bpm/engine/test/history/CAM-9934.bpmn"})
