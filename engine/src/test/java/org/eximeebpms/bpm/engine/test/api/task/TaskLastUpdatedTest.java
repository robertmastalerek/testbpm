...
public class TaskLastUpdatedTest {
  ...
  public void shouldSetLastUpdatedOnCreateAttachment() {
    ...
    // when
    taskService.createAttachment(null, task.getId(), processInstance.getId(), "myAttachment", "attachmentDescription", "http://eximeebpms.com");
  ...
  public void shouldSetLastUpdatedOnChangeAttachment() {
    ...
    ProcessInstance processInstance = runtimeService.startProcessInstanceByKey("oneTaskProcess");
    Task task = taskService.createTaskQuery().processInstanceId(processInstance.getId()).singleResult();
    Attachment attachment = taskService.createAttachment(null, task.getId(), processInstance.getId(), "myAttachment", "attachmentDescription", "http://eximeebpms.com");
  ...
  @Test
  @Deployment(resources = {"org/eximeebpms/bpm/engine/test/api/form/DeployedCamundaFormSingleTaskProcess.bpmn20.xml",
