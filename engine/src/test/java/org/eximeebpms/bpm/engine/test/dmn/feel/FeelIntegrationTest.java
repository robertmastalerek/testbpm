...
public class FeelIntegrationTest {
  ...
  @Test
  @Deployment(resources = {"org/eximeebpms/bpm/engine/test/dmn/feel/literal-expression.dmn"})
  ...
  @Test
  @Deployment(resources = {"org/eximeebpms/bpm/engine/test/dmn/feel/input-expression.dmn"})
  ...
  @Test
  @Deployment(resources = {"org/eximeebpms/bpm/engine/test/dmn/feel/input-rule.dmn"})
  ...
  @Test
  @Deployment(resources = {"org/eximeebpms/bpm/engine/test/dmn/feel/output-rule.dmn"})
