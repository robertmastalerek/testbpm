...
public class JobDefinitionPriorityTest extends PluggableProcessEngineTest {
  ...
  public void testRedeployOverridesSetJobDefinitionPriority() {
    ...
    String secondDeploymentId = repositoryService.createDeployment().addClasspathResource("org/eximeebpms/bpm/engine/test/api/mgmt/jobPrioProcess.bpmn20.xml").deploy().getId();
