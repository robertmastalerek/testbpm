...
public class HistoricIncidentAuthorizationTest extends AuthorizationTest {
  ...
  public void setUp() throws Exception {
    deploymentId = testRule.deploy(
        "org/eximeebpms/bpm/engine/test/api/authorization/timerStartEventProcess.bpmn20.xml",
        "org/eximeebpms/bpm/engine/test/api/authorization/oneIncidentProcess.bpmn20.xml",
        "org/eximeebpms/bpm/engine/test/api/authorization/anotherOneIncidentProcess.bpmn20.xml").getId();
    super.setUp();
  }
