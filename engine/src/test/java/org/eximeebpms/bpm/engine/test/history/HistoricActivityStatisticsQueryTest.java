...
public class HistoricActivityStatisticsQueryTest extends PluggableProcessEngineTest {
  ...
  @Deployment(resources = {"org/eximeebpms/bpm/engine/test/history/HistoricActivityStatisticsQueryTest.testWithCallActivity.bpmn20.xml",
      "org/eximeebpms/bpm/engine/test/history/HistoricActivityStatisticsQueryTest.calledProcess.bpmn20.xml" })
  @Test
  ...
  @Deployment(resources= {"org/eximeebpms/bpm/engine/test/history/HistoricActivityStatisticsQueryTest.testSingleTask.bpmn20.xml",
      "org/eximeebpms/bpm/engine/test/history/HistoricActivityStatisticsQueryTest.testAnotherSingleTask.bpmn20.xml"})
  @Test
