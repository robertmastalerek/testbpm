 ...
 */
package org.eximeebpms.bpm.engine.test.cmmn.processtask;
...
public class ProcessTaskTest extends CmmnTest {
  ...
  @Deployment(resources = {
      "org/eximeebpms/bpm/engine/test/cmmn/processtask/ProcessTaskTest.testCallProcessAsExpressionStartsWithDollar.cmmn",
      "org/eximeebpms/bpm/engine/test/api/oneTaskProcess.bpmn20.xml"
    })
  @Test
  ...
  @Deployment(resources = {
      "org/eximeebpms/bpm/engine/test/cmmn/processtask/ProcessTaskTest.testCallProcessAsExpressionStartsWithHash.cmmn",
      "org/eximeebpms/bpm/engine/test/api/oneTaskProcess.bpmn20.xml"
    })
  @Test
  ...
  @Deployment(resources = {
      "org/eximeebpms/bpm/engine/test/cmmn/processtask/ProcessTaskTest.testCallLatestProcess.cmmn",
      "org/eximeebpms/bpm/engine/test/api/oneTaskProcess.bpmn20.xml"
    })
  @Test
  ...
  @Deployment(resources = {
      "org/eximeebpms/bpm/engine/test/cmmn/processtask/ProcessTaskTest.testCallProcessByDeployment.cmmn",
      "org/eximeebpms/bpm/engine/test/api/oneTaskProcess.bpmn20.xml"
    })
  @Test
  ...
  @Deployment(resources = {
      "org/eximeebpms/bpm/engine/test/cmmn/processtask/ProcessTaskTest.testCallProcessByVersion.cmmn",
      "org/eximeebpms/bpm/engine/test/api/oneTaskProcess.bpmn20.xml"
    })
  @Test
  ...
  @Deployment(resources = {
      "org/eximeebpms/bpm/engine/test/cmmn/processtask/ProcessTaskTest.testCallProcessByVersionAsExpressionStartsWithDollar.cmmn",
      "org/eximeebpms/bpm/engine/test/api/oneTaskProcess.bpmn20.xml"
    })
  @Test
  ...
  @Deployment(resources = {
      "org/eximeebpms/bpm/engine/test/cmmn/processtask/ProcessTaskTest.testCallProcessByVersionAsExpressionStartsWithHash.cmmn",
      "org/eximeebpms/bpm/engine/test/api/oneTaskProcess.bpmn20.xml"
    })
  @Test
  ...
  @Deployment(resources = {
      "org/eximeebpms/bpm/engine/test/cmmn/processtask/ProcessTaskTest.testInputBusinessKey.cmmn",
      "org/eximeebpms/bpm/engine/test/api/oneTaskProcess.bpmn20.xml"
    })
  @Test
  ...
  @Deployment(resources = {
      "org/eximeebpms/bpm/engine/test/cmmn/processtask/ProcessTaskTest.testInputDifferentBusinessKey.cmmn",
      "org/eximeebpms/bpm/engine/test/api/oneTaskProcess.bpmn20.xml"
    })
  @Test
  ...
  @Deployment(resources = {
      "org/eximeebpms/bpm/engine/test/cmmn/processtask/ProcessTaskTest.testInputSource.cmmn",
      "org/eximeebpms/bpm/engine/test/api/oneTaskProcess.bpmn20.xml"
    })
  @Test
  ...
  @Deployment(resources = {
      "org/eximeebpms/bpm/engine/test/cmmn/processtask/ProcessTaskTest.testInputSourceDifferentTarget.cmmn",
      "org/eximeebpms/bpm/engine/test/api/oneTaskProcess.bpmn20.xml"
    })
  @Test
  ...
  @Deployment(resources = {
      "org/eximeebpms/bpm/engine/test/cmmn/processtask/ProcessTaskTest.testInputSourceExpression.cmmn",
      "org/eximeebpms/bpm/engine/test/api/oneTaskProcess.bpmn20.xml"
    })
  @Test
  ...
  @Deployment(resources = {
      "org/eximeebpms/bpm/engine/test/cmmn/processtask/ProcessTaskTest.testInputAll.cmmn",
      "org/eximeebpms/bpm/engine/test/api/oneTaskProcess.bpmn20.xml"
    })
  @Test
  ...
  @Deployment(resources = {
      "org/eximeebpms/bpm/engine/test/cmmn/processtask/ProcessTaskTest.testInputAllLocal.cmmn",
      "org/eximeebpms/bpm/engine/test/api/oneTaskProcess.bpmn20.xml"
    })
  @Test
  ...
  @Deployment(resources = {
      "org/eximeebpms/bpm/engine/test/cmmn/processtask/ProcessTaskTest.testInputOverlapping.cmmn",
      "org/eximeebpms/bpm/engine/test/api/oneTaskProcess.bpmn20.xml"
    })
  @Test
  ...
  @Deployment(resources = {
      "org/eximeebpms/bpm/engine/test/api/cmmn/oneProcessTaskCaseWithManualActivation.cmmn"
    })
  @Test
  ...
  @Deployment(resources = {
      "org/eximeebpms/bpm/engine/test/cmmn/processtask/ProcessTaskTest.testOutputSource.cmmn",
      "org/eximeebpms/bpm/engine/test/api/oneTaskProcess.bpmn20.xml"
    })
  @Test
  ...
  @Deployment(resources = {
      "org/eximeebpms/bpm/engine/test/cmmn/processtask/ProcessTaskTest.testOutputSourceDifferentTarget.cmmn",
      "org/eximeebpms/bpm/engine/test/api/oneTaskProcess.bpmn20.xml"
    })
  @Test
  ...
  @Deployment(resources = {
      "org/eximeebpms/bpm/engine/test/cmmn/processtask/ProcessTaskTest.testOutputSourceExpression.cmmn",
      "org/eximeebpms/bpm/engine/test/api/oneTaskProcess.bpmn20.xml"
    })
  @Test
  ...
  @Deployment(resources = {
      "org/eximeebpms/bpm/engine/test/cmmn/processtask/ProcessTaskTest.testOutputAll.cmmn",
      "org/eximeebpms/bpm/engine/test/api/oneTaskProcess.bpmn20.xml"
    })
  @Test
  ...
  @Deployment(resources = {
      "org/eximeebpms/bpm/engine/test/cmmn/processtask/ProcessTaskTest.testOutputOverlapping.cmmn",
      "org/eximeebpms/bpm/engine/test/api/oneTaskProcess.bpmn20.xml"
    })
  @Test
  ...
  @Deployment(resources = {
      "org/eximeebpms/bpm/engine/test/cmmn/processtask/ProcessTaskTest.testOutputAllWithManualActivation.cmmn",
      "org/eximeebpms/bpm/engine/test/api/oneTaskProcess.bpmn20.xml"
    })
  @Test
  ...
  @Deployment(resources = {
      "org/eximeebpms/bpm/engine/test/cmmn/processtask/ProcessTaskTest.testVariablesRoundtrip.cmmn",
      "org/eximeebpms/bpm/engine/test/api/oneTaskProcess.bpmn20.xml"
    })
  @Test
  ...
  @Deployment(resources = {
      "org/eximeebpms/bpm/engine/test/cmmn/processtask/ProcessTaskTest.testInputOutputAll.cmmn",
      "org/eximeebpms/bpm/engine/test/api/oneTaskProcess.bpmn20.xml"
    })
  @Test
  ...
  @Deployment(resources = {
      "org/eximeebpms/bpm/engine/test/cmmn/processtask/ProcessTaskTest.testNonBlockingProcessTask.cmmn",
      "org/eximeebpms/bpm/engine/test/api/oneTaskProcess.bpmn20.xml"
    })
  @Test
  ...
  @Deployment(resources = {
      "org/eximeebpms/bpm/engine/test/cmmn/processtask/ProcessTaskTest.testProcessInstanceCompletesInOneGo.cmmn",
      "org/eximeebpms/bpm/engine/test/cmmn/processtask/ProcessTaskTest.testProcessInstanceCompletesInOneGo.bpmn20.xml"
    })
  @Test
  ...
  @Deployment(resources = {
      "org/eximeebpms/bpm/engine/test/cmmn/processtask/ProcessTaskTest.testNonBlockingProcessTaskAndProcessInstanceCompletesInOneGo.cmmn",
      "org/eximeebpms/bpm/engine/test/cmmn/processtask/ProcessTaskTest.testProcessInstanceCompletesInOneGo.bpmn20.xml"
    })
  @Test
  ...
  @Deployment(resources = {
      "org/eximeebpms/bpm/engine/test/cmmn/processtask/ProcessTaskTest.testStartProcessInstanceAsync.cmmn",
      "org/eximeebpms/bpm/engine/test/cmmn/processtask/ProcessTaskTest.testStartProcessInstanceAsync.bpmn20.xml"
    })
  @Test
  ...
  @Deployment(resources = {"org/eximeebpms/bpm/engine/test/cmmn/processtask/ProcessTaskTest.testOutputAll.cmmn",
      "org/eximeebpms/bpm/engine/test/cmmn/processtask/subProcessWithError.bpmn"})
  @Test
  ...
  @Deployment(resources = {"org/eximeebpms/bpm/engine/test/cmmn/processtask/ProcessTaskTest.testOutputAll.cmmn",
  "org/eximeebpms/bpm/engine/test/cmmn/processtask/subProcessWithThrownError.bpmn"})
  @Test
