...
public class ProcessDefinitionSuspensionTest extends PluggableProcessEngineTest {
  ...
  @Deployment(resources={"org/eximeebpms/bpm/engine/test/api/repository/processOne.bpmn20.xml"})
  @Test
  ...
  @Deployment(resources={
          "org/eximeebpms/bpm/engine/test/api/repository/processOne.bpmn20.xml",
          "org/eximeebpms/bpm/engine/test/api/repository/processTwo.bpmn20.xml"
          })
  @Test
  ...
  public void testSuspendMultipleProcessDefinitionsByKey () {
    ...
    for (int i=0; i<nrOfProcessDefinitions; i++) {
      repositoryService.createDeployment()
        .addClasspathResource("org/eximeebpms/bpm/engine/test/api/runtime/oneTaskProcess.bpmn20.xml").deploy();
    }
  ...
  public void testMultipleSuspendByKey_shouldSuspendJobDefinitionAndRetainJob() {
    ...
    for (int i=0; i<nrOfProcessDefinitions; i++) {
      repositoryService.createDeployment()
        .addClasspathResource("org/eximeebpms/bpm/engine/test/api/repository/ProcessDefinitionSuspensionTest.testWithOneAsyncServiceTask.bpmn").deploy();
  ...
  @Deployment(resources = {"org/eximeebpms/bpm/engine/test/api/repository/ProcessDefinitionSuspensionTest.testSuspendStartTimerOnProcessDefinitionSuspension.bpmn20.xml"})
  @Test
