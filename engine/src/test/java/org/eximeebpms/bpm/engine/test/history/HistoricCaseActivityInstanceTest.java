...
import org.eximeebpms.bpm.engine.impl.history.event.HistoricCaseActivityInstanceEventEntity;
import org.eximeebpms.bpm.engine.impl.persistence.entity.HistoricCaseActivityInstanceEntity;
...
public class HistoricCaseActivityInstanceTest extends CmmnTest {
  ...
  @Deployment(resources={"org/eximeebpms/bpm/engine/test/api/cmmn/emptyStageWithManualActivationCase.cmmn"})
  @Test
  ...
  @Deployment(resources = {
    "org/eximeebpms/bpm/engine/test/api/cmmn/oneCaseTaskCaseWithManualActivation.cmmn",
  ...
  @Deployment(resources = {"org/eximeebpms/bpm/engine/test/api/cmmn/oneTaskAndOneStageWithManualActivationCase.cmmn"})
  @Test
  ...
  @Deployment(resources = "org/eximeebpms/bpm/engine/test/cmmn/required/RequiredRuleTest.testVariableBasedRule.cmmn")
  @Test
  ...
  @Deployment(resources = {"org/eximeebpms/bpm/engine/test/cmmn/stage/AutoCompleteTest.testCasePlanModel.cmmn"})
  @Test
  ...
  @Deployment(resources = {"org/eximeebpms/bpm/engine/test/cmmn/repetition/RepetitionRuleTest.testRepeatTask.cmmn"})
  @Test
  ...
  @Deployment(resources = {"org/eximeebpms/bpm/engine/test/cmmn/repetition/RepetitionRuleTest.testRepeatStage.cmmn"})
  @Test
  ...
  @Deployment(resources = {"org/eximeebpms/bpm/engine/test/cmmn/repetition/RepetitionRuleTest.testRepeatMilestone.cmmn"})
  @Test
  ...
  @Deployment(resources = {"org/eximeebpms/bpm/engine/test/cmmn/repetition/RepetitionRuleTest.testAutoCompleteStage.cmmn"})
  @Test
  ...
  @Deployment(resources = {"org/eximeebpms/bpm/engine/test/cmmn/repetition/RepetitionRuleTest.testAutoCompleteStageWithoutEntryCriteria.cmmn"})
  @Test
  ...
  @Deployment(resources = {"org/eximeebpms/bpm/engine/test/history/HistoricCaseActivityInstanceTest.oneStageAndOneTaskCaseWithManualActivation.cmmn"})
  @Test
  ...
  @Deployment(resources = {"org/eximeebpms/bpm/engine/test/history/HistoricCaseActivityInstanceTest.oneStageWithSentryAsEntryPointCase.cmmn"})
  @Test
  ...
  @Deployment(resources={
    "org/eximeebpms/bpm/engine/test/api/cmmn/oneProcessTaskCaseWithManualActivation.cmmn",
    "org/eximeebpms/bpm/engine/test/history/HistoricCaseActivityInstanceTest.oneTaskProcess.bpmn20.xml"
  })
  @Test
