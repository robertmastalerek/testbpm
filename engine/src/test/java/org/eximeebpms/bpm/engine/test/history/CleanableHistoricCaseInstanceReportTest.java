...
public class CleanableHistoricCaseInstanceReportTest {
  ...
  public void setUp() {
    ...
    testRule.deploy("org/eximeebpms/bpm/engine/test/repository/one.cmmn");
  }
  ...
  public void testReportComplex() {
    // given
    testRule.deploy("org/eximeebpms/bpm/engine/test/api/cmmn/oneCaseTaskCase.cmmn", "org/eximeebpms/bpm/engine/test/api/cmmn/oneTaskCase.cmmn",
        "org/eximeebpms/bpm/engine/test/api/cmmn/oneTaskCaseWithHistoryTimeToLive.cmmn");
