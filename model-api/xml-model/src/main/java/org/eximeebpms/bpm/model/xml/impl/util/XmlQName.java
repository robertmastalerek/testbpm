...
public class XmlQName {
  ...
  static
  {
    ...
    KNOWN_PREFIXES.put("http://eximeebpms.org/fox", "fox");
    KNOWN_PREFIXES.put("http://activiti.org/bpmn", "eximeebpms");
    KNOWN_PREFIXES.put("http://eximeebpms.org/schema/1.0/bpmn", "eximeebpms");
