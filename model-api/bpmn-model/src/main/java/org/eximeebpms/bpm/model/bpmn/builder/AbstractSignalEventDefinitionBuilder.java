...
public abstract class AbstractSignalEventDefinitionBuilder<B extends AbstractSignalEventDefinitionBuilder<B>> extends AbstractRootElementBuilder<B, SignalEventDefinition> {
  ...
  /**
   * Sets a "eximeebpms:in" parameter to pass a variable from the signal-throwing
  ...
  /**
   * Sets a "eximeebpms:in" parameter to pass an expression from the signal-throwing
  ...
  /**
   * Sets a "eximeebpms:in" parameter to pass the business key from the signal-throwing
   * process instance to the signal-catching process instance
   *
  ...
  /**
   * Sets a "eximeebpms:in" parameter to pass all the process variables of the
