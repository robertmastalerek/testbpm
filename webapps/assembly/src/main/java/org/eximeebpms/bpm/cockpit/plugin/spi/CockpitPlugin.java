 ...
 */
package org.eximeebpms.bpm.cockpit.plugin.spi;
 ...
 * {@link org.eximeebpms.bpm.cockpit.plugin.spi.impl.AbstractCockpitPlugin} as a base class.
 *
 * @author nico.rehwaldt
 *
 * @see org.eximeebpms.bpm.cockpit.plugin.spi.impl.AbstractCockpitPlugin
 */
public interface CockpitPlugin extends AppPlugin {
   ...
   * <p>
   *
   * Inside the plugin the queries may be executed via the {@link org.eximeebpms.bpm.cockpit.db.QueryService} that may be obtained through
   * {@link org.eximeebpms.bpm.cockpit.Cockpit#getQueryService(java.lang.String) }.
   *
