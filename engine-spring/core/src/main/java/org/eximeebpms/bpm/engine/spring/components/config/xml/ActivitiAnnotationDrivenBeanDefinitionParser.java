 ...
 */
package org.eximeebpms.bpm.engine.spring.components.config.xml;


import org.eximeebpms.bpm.engine.spring.components.ActivitiContextUtils;
import org.eximeebpms.bpm.engine.spring.components.aop.ProcessStartAnnotationBeanPostProcessor;
...
/**
 * registers support for handling the annotations in the org.eximeebpms.bpm.engine.annotations package.
 * <p/>
 ...
 * {@link org.eximeebpms.bpm.engine.test.spring.components.registry.ActivitiStateHandlerRegistry} if none exists.
 *
 * @author Josh Long
 * @since 5.3
 */
