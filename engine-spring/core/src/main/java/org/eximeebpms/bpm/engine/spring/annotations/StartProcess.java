...
public @interface StartProcess {
	...
	/**
	 * returns the ID of the {@link org.eximeebpms.bpm.engine.runtime.ProcessInstance}. If specified, it'll only work if
	 * the return type of the invocation is compatabile with a {@link org.eximeebpms.bpm.engine.runtime.ProcessInstance}'s ID
