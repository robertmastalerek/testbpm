 ...
 */
package org.eximeebpms.bpm.engine.spring.components.registry;
...
/**
 * this class records and manages all known {@link org.eximeebpms.bpm.engine.annotations.State} - responding
...
public class ActivitiStateHandlerRegistry extends ReceiveTaskActivityBehavior implements BeanFactoryAware, BeanNameAware, ActivityBehavior, InitializingBean {
	...
	protected String registrationKey(String stateName, String processName) {
		return (org.eximeebpms.commons.utils.StringUtil.defaultString(processName) +
				":" + org.eximeebpms.commons.utils.StringUtil.defaultString(stateName)).toLowerCase();
	}

	/**
	 * used at runtime to register state handlers as they are registered with the spring context
	 *
	 * @param registration the {@link org.eximeebpms.bpm.engine.test.spring.components.registry.ActivitiStateHandlerRegistration}
	 */
	 ...
	 * on specificity of the {@link org.eximeebpms.bpm.engine.test.spring.components.registry.ActivitiStateHandlerRegistration}
	 *
	 ...
	 * @return an unambiguous {@link org.eximeebpms.bpm.engine.test.spring.components.registry.ActivitiStateHandlerRegistry} or null
	 */
