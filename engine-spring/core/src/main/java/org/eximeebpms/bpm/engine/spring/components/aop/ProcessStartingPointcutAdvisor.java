...
import org.eximeebpms.bpm.engine.spring.components.aop.util.MetaAnnotationMatchingPointcut;
 ...
 * type of {@link org.eximeebpms.bpm.engine.runtime.ProcessInstance} and then subsequently
...
public class ProcessStartingPointcutAdvisor implements PointcutAdvisor, Serializable {
	...
	/**
	 * the injected reference to the {@link org.eximeebpms.bpm.engine.ProcessEngine}
	 */
