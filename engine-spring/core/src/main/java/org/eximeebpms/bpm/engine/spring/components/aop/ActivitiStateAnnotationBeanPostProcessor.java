 ...
 */
package org.eximeebpms.bpm.engine.spring.components.aop;
...
import org.eximeebpms.bpm.engine.spring.annotations.ProcessId;
import org.eximeebpms.bpm.engine.spring.annotations.ProcessVariable;
import org.eximeebpms.bpm.engine.spring.annotations.ProcessVariables;
import org.eximeebpms.bpm.engine.spring.annotations.State;
import org.eximeebpms.bpm.engine.spring.components.registry.ActivitiStateHandlerRegistration;
import org.eximeebpms.bpm.engine.spring.components.registry.ActivitiStateHandlerRegistry;
 ...
 * that have the {@link org.eximeebpms.bpm.engine.annotations.State} annotation.
 *
 * @author Josh Long
 * @since 5.3
 */
...
public class ActivitiStateAnnotationBeanPostProcessor implements BeanPostProcessor, BeanClassLoaderAware, BeanFactoryAware, InitializingBean, Ordered {
	...
	public Object postProcessAfterInitialization(final Object bean,
		...
		final org.eximeebpms.bpm.engine.spring.annotations.ProcessEngineComponent component = targetClass.getAnnotation(org.eximeebpms.bpm.engine.spring.annotations.ProcessEngineComponent.class);
