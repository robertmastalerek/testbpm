 ...
 */
package org.eximeebpms.bpm.engine.spring.test.expression.callactivity;
 ...
 */
@ContextConfiguration("classpath:org/eximeebpms/bpm/engine/spring/test/expression/callactivity/testCallActivityByExpression-context.xml")
public class CallActivityBasedOnSpringBeansExpressionTest extends SpringProcessEngineTestCase {

	@Deployment(resources = {
			"org/eximeebpms/bpm/engine/spring/test/expression/callactivity/CallActivityBasedOnSpringBeansExpressionTest.testCallActivityByExpression.bpmn20.xml",
			"org/eximeebpms/bpm/engine/spring/test/expression/callactivity/simpleSubProcess.bpmn20.xml" })
