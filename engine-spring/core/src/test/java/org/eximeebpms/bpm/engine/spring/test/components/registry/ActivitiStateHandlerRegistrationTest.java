 ...
 */
package org.eximeebpms.bpm.engine.spring.test.components.registry;
...
public class ActivitiStateHandlerRegistrationTest {
  ...
  public void shouldHaveDetailledStringRepresentation() throws Exception {
    ...
    assertEquals("org.eximeebpms.bpm.engine.spring.components.registry.ActivitiStateHandlerRegistration@" + Integer.toHexString(registration.hashCode()) + "["
        + "processVariablesExpected={34=testValue}, "
        + "handlerMethod=public void org.eximeebpms.bpm.engine.spring.test.components.registry.ActivitiStateHandlerRegistrationTest.shouldHaveDetailledStringRepresentation() throws java.lang.Exception, "
        + "handler=org.eximeebpms.bpm.engine.spring.test.components.registry.ActivitiStateHandlerRegistrationTest$1@" + Integer.toHexString(handler.hashCode()) + ", "
        + "stateName=running, "
        + "beanName=testBean, "
