 ...
 */
package org.eximeebpms.bpm.engine.spring.test.container;

import org.eximeebpms.bpm.BpmPlatform;
import org.eximeebpms.bpm.engine.spring.container.ManagedProcessEngineFactoryBean;
...
public class ManagedProcessEngineFactoryBeanTest {
  ...
  public void testProcessApplicationDeployment() {
    ...
    AbstractApplicationContext applicationContext = new ClassPathXmlApplicationContext("org/eximeebpms/bpm/engine/spring/test/container/ManagedProcessEngineFactoryBean-context.xml");
