...
import org.eximeebpms.bpm.engine.spring.test.components.ProcessInitiatingPojo;
...
@ContextConfiguration("classpath:org/eximeebpms/bpm/engine/spring/test/components/ScopingTests-context.xml")
	...
	public void before() throws Throwable {
	  this.repositoryService = this.processEngine.getRepositoryService();
		...
		repositoryService.createDeployment()
		  .addClasspathResource("org/eximeebpms/bpm/engine/spring/test/autodeployment/autodeploy.b.bpmn20.xml")
		  .addClasspathResource("org/eximeebpms/bpm/engine/spring/test/components/waiter.bpmn20.xml")
		  .addClasspathResource("org/eximeebpms/bpm/engine/spring/test/components/spring-component-waiter.bpmn20.xml")
		  .deploy();
	}
