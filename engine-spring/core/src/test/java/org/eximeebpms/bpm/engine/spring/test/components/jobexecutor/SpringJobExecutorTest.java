 ...
 */
package org.eximeebpms.bpm.engine.spring.test.components.jobexecutor;
 ...
 * @author Pablo Ganga
 */
@ContextConfiguration("classpath:org/eximeebpms/bpm/engine/spring/test/components/SpringjobExecutorTest-context.xml")
public class SpringJobExecutorTest extends SpringProcessEngineTestCase {

  @Deployment(resources={"org/eximeebpms/bpm/engine/spring/test/components/SpringTimersProcess.bpmn20.xml",
          "org/eximeebpms/bpm/engine/spring/test/components/SpringJobExecutorRollBack.bpmn20.xml"})
