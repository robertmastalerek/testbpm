 ...
 */
package org.eximeebpms.bpm.engine.spring.test.servicetask;
 ...
 * @author Falko Menge
 */
@ContextConfiguration("classpath:org/eximeebpms/bpm/engine/spring/test/servicetask/serviceraskSpringTestCatchError-context.xml")
