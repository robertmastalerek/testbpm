 ...
 */
package org.eximeebpms.bpm.engine.spring.test.application;
...
public class SpringProcessApplicationTest {
  ...
  public void testProcessApplicationDeployment() {
    ...
    AbstractApplicationContext applicationContext = new ClassPathXmlApplicationContext("org/eximeebpms/bpm/engine/spring/test/application/SpringProcessApplicationDeploymentTest-context.xml");
  ...
  public void testDeployProcessArchive() {
    ...
    // start a spring application context
    AbstractApplicationContext applicationContext = new ClassPathXmlApplicationContext("org/eximeebpms/bpm/engine/spring/test/application/SpringProcessArchiveDeploymentTest-context.xml");
    applicationContext.start();
  ...
  public void testPostDeployRegistrationPa() {
    ...
    AbstractApplicationContext applicationContext = new ClassPathXmlApplicationContext("org/eximeebpms/bpm/engine/spring/test/application/PostDeployRegistrationPaTest-context.xml");
    applicationContext.start();
    ...
    Deployment deployment = processEngine.getRepositoryService()
      .createDeployment()
      .addClasspathResource("org/eximeebpms/bpm/engine/spring/test/application/process.bpmn20.xml")
      .deploy();
  ...
  public void testPostDeployWithNestedContext() {
    ...
    AbstractApplicationContext applicationContext = new ClassPathXmlApplicationContext(
        "org/eximeebpms/bpm/engine/spring/test/application/PostDeployWithNestedContext-context.xml");
    applicationContext.start();
