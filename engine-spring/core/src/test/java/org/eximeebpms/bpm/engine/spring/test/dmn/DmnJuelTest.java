 ...
 */
package org.eximeebpms.bpm.engine.spring.test.dmn;
...
@ContextConfiguration(locations = {
    "classpath:org/eximeebpms/bpm/engine/spring/test/dmn/DmnJuelTest-applicationContext.xml" })
public class DmnJuelTest {
  ...
  public void deploy() {
    deploymentId = repositoryService.createDeployment()
        .addClasspathResource("org/eximeebpms/bpm/engine/spring/test/dmn/JuelTest.dmn")
        .deploy()
        .getId();
  }
