 ...
 */
package org.eximeebpms.bpm.engine.spring.test.transaction.modification;
...
@ContextConfiguration(locations = {"classpath:org/eximeebpms/bpm/engine/spring/test/transaction/ProcessInstanceModificationInTransactionTest-applicationContext.xml"})
