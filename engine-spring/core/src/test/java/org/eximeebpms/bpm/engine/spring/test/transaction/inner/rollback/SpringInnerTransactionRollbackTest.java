 ...
 */
package org.eximeebpms.bpm.engine.spring.test.transaction.inner.rollback;
...
@ContextConfiguration(locations = {"classpath:org/eximeebpms/bpm/engine/spring/test/transaction/"
...
public class SpringInnerTransactionRollbackTest {
  ...
  @Deployment(resources = {
    "org/eximeebpms/bpm/engine/spring/test/transaction/"
