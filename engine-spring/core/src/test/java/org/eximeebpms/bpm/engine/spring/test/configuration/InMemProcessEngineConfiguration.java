 ...
 */
package org.eximeebpms.bpm.engine.spring.test.configuration;
 ...
 */
@Configuration
@ComponentScan("org.eximeebpms.bpm.engine.spring.test.configuration")
public class InMemProcessEngineConfiguration {
  ...
  public DataSource dataSource() {
    ...
    dataSource.setUrl("jdbc:h2:mem:eximeebpms-test;DB_CLOSE_DELAY=-1");
