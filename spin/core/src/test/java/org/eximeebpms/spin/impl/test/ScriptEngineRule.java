 ...
 */
package org.eximeebpms.spin.impl.test;
...
public class ScriptEngineRule implements TestRule {
  ...
  /**
   * Create script engine from {@literal @}{@link org.eximeebpms.spin.impl.test.ScriptEngine} Annotation. The created
  ...
  private ScriptEngine createScriptEngine(Description description) {
    org.eximeebpms.spin.impl.test.ScriptEngine annotation = description.getTestClass().getAnnotation(org.eximeebpms.spin.impl.test.ScriptEngine.class);
    if (annotation == null) {
      return null;
    }
    else {
  ...
  /**
   * Get the script engine defined by the {@literal @}{@link org.eximeebpms.spin.impl.test.ScriptEngine} Annotation
   *
