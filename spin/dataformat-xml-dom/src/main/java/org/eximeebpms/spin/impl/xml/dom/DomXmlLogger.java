 ...
 */
package org.eximeebpms.spin.impl.xml.dom;
...
import org.eximeebpms.spin.xml.SpinXmlAttributeException;
import org.eximeebpms.spin.xml.SpinXmlDataFormatException;
import org.eximeebpms.spin.xml.SpinXmlElement;
import org.eximeebpms.spin.xml.SpinXmlElementException;
import org.eximeebpms.spin.xml.SpinXmlElementImplementationException;
...
public class DomXmlLogger extends SpinLogger {
  ...
  public static final DomXmlLogger XML_DOM_LOGGER = BaseLogger.createLogger(DomXmlLogger.class, PROJECT_CODE, "org.eximeebpms.spin.xml", "01");
