...
import org.eximeebpms.spin.SpinFactory;
import org.eximeebpms.spin.spi.DataFormat;
import org.eximeebpms.spin.xml.JdkUtil;
...
public class DomXmlDataFormatWriterTest {
  ...
  // see https://github.com/eximeebpms/eximeebpms-bpm-platform/blob/master/engine-plugins/spin-plugin/src/main/java/org/eximeebpms/spin/plugin/impl/SpinValueSerializer.java
  ...
  /**
   * new feature provided by https://github.com/eximeebpms/eximeebpms-bpm-platform/issues/3633: custom formatting
  ...
  public void testCustomStripSpaceXSL() throws Exception {
    ...
    try (final InputStream inputStream = DomXmlDataFormatWriterTest.class.getClassLoader()
        .getResourceAsStream("org/eximeebpms/spin/strip-space-preserve-space.xsl")) {
