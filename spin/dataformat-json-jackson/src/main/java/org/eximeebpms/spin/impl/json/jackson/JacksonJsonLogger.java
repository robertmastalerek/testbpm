 ...
 */
package org.eximeebpms.spin.impl.json.jackson;

import org.eximeebpms.commons.logging.BaseLogger;
import org.eximeebpms.spin.impl.logging.SpinLogger;
import org.eximeebpms.spin.json.SpinJsonDataFormatException;
import org.eximeebpms.spin.json.SpinJsonException;
import org.eximeebpms.spin.json.SpinJsonNode;
import org.eximeebpms.spin.json.SpinJsonPathException;
import org.eximeebpms.spin.json.SpinJsonPropertyException;
...
public class JacksonJsonLogger extends SpinLogger {
  ...
  public static final JacksonJsonLogger JSON_TREE_LOGGER = BaseLogger.createLogger(JacksonJsonLogger.class, PROJECT_CODE, "org.eximeebpms.spin.json", "01");
