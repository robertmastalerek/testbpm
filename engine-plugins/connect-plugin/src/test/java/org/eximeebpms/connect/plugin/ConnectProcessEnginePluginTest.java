...
import org.eximeebpms.connect.ConnectorException;
...
import org.eximeebpms.connect.plugin.util.TestConnector;
...
public class ConnectProcessEnginePluginTest extends PluggableProcessEngineTestCase {
  ...
  public void testConnectorIdMissing() {
    try {
      repositoryService.createDeployment().addClasspathResource("org/eximeebpms/connect/plugin/ConnectProcessEnginePluginTest.testConnectorIdMissing.bpmn")
        .deploy();
  ...
  @Deployment(resources="org/eximeebpms/connect/plugin/ConnectProcessEnginePluginTest.testConnectorWithThrownExceptionInScriptInputOutputMapping.bpmn")
  ...
  @Deployment(resources="org/eximeebpms/connect/plugin/ConnectProcessEnginePluginTest.testConnectorWithThrownExceptionInScriptResourceInputOutputMapping.bpmn")
  ...
  @Deployment(resources="org/eximeebpms/connect/plugin/ConnectProcessEnginePluginTest.testConnectorBpmnErrorThrownInScriptResourceNoAsyncAfterJobIsCreated.bpmn")
