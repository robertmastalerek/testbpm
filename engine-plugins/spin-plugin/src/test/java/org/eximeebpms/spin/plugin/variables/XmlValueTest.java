...
import static org.eximeebpms.spin.DataFormats.xml;
import static org.eximeebpms.spin.plugin.variable.SpinValues.xmlValue;
import static org.eximeebpms.spin.plugin.variable.type.SpinValueType.XML;
...
import org.eximeebpms.spin.plugin.variable.type.SpinValueType;
import org.eximeebpms.spin.plugin.variable.value.XmlValue;
import org.eximeebpms.spin.plugin.variable.value.builder.XmlValueBuilder;
...
public class XmlValueTest extends PluggableProcessEngineTestCase {
  ...
  @Deployment(resources = "org/eximeebpms/spin/plugin/xmlConditionProcess.bpmn20.xml")
