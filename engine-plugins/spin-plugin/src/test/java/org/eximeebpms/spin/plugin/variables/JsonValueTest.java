...
import static org.eximeebpms.spin.plugin.variable.SpinValues.jsonValue;
import static org.eximeebpms.spin.plugin.variable.type.SpinValueType.JSON;
...
import org.eximeebpms.spin.plugin.variable.value.builder.JsonValueBuilder;
...
public class JsonValueTest extends PluggableProcessEngineTestCase {
  ...
  @Deployment(resources = "org/eximeebpms/spin/plugin/jsonConditionProcess.bpmn20.xml")
