...
import static org.eximeebpms.spin.plugin.variables.TypedValueAssert.assertObjectValueDeserializedNull;
import static org.eximeebpms.spin.plugin.variables.TypedValueAssert.assertObjectValueSerializedNull;
import static org.eximeebpms.spin.plugin.variables.TypedValueAssert.assertUntypedNullValue;
...
public class XmlSerializationTest extends PluggableProcessEngineTestCase {
  ...
  protected static final String ONE_TASK_PROCESS = "org/eximeebpms/spin/plugin/oneTaskProcess.bpmn20.xml";
  ...
  public void testOverloadedAppendMethod() {
    ...
    Reader xmlInput = SpinIoUtil.classpathResourceAsReader("org/eximeebpms/spin/plugin/XmlSerializationTest-input.xml");
    String expectedOutput = SpinIoUtil.fileAsString("org/eximeebpms/spin/plugin/XmlSerializationTest-output.xml");
