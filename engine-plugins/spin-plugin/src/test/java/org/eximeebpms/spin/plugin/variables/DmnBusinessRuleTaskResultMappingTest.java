...
import org.eximeebpms.bpm.engine.impl.test.ResourceProcessEngineTestCase;
...
public class DmnBusinessRuleTaskResultMappingTest extends ResourceProcessEngineTestCase {
  ...
  protected static final String TEST_DECISION = "org/eximeebpms/spin/plugin/DmnBusinessRuleTaskResultMappingTest.dmn11.xml";
  protected static final String CUSTOM_MAPPING_BPMN = "org/eximeebpms/spin/plugin/DmnBusinessRuleTaskResultMappingTest.testCustomOutputMapping.bpmn20.xml";
  protected static final String SINGLE_ENTRY_BPMN = "org/eximeebpms/spin/plugin/DmnBusinessRuleTaskResultMappingTest.testSingleEntry.bpmn20.xml";
  protected static final String DEFAULT_MAPPING_BPMN = "org/eximeebpms/spin/plugin/DmnBusinessRuleTaskResultMappingTest.testDefaultMapping.bpmn20.xml";
  protected static final String STORE_DECISION_RESULT_BPMN = "org/eximeebpms/spin/plugin/DmnBusinessRuleTaskResultMappingTest.testStoreDecisionResult.bpmn20.xml";

  public DmnBusinessRuleTaskResultMappingTest() {
    super("org/eximeebpms/spin/plugin/json.eximeebpms.cfg.xml");
  }
