...
import static org.eximeebpms.bpm.identity.ldap.util.LdapTestUtilities.testGroupPaging;
...
import org.eximeebpms.bpm.identity.ldap.util.LdapTestUtilities;
...
public class LdapDisableAuthorizationCheckTest {
  ...
  @Rule
  public ProcessEngineRule engineRule = new ProcessEngineRule("eximeebpms.ldap.disable.authorization.check.cfg.xml");
