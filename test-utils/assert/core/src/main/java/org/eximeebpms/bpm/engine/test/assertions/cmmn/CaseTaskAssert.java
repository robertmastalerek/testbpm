...
public class CaseTaskAssert extends AbstractCaseAssert<CaseTaskAssert, CaseExecution> {
  ...
  /**
   * Verifies the expectation that the {@link org.eximeebpms.bpm.model.cmmn.instance.CaseTask} holds no
  ...
  /**
   * Verifies the expectation that the {@link org.eximeebpms.bpm.model.cmmn.instance.CaseTask} holds one or
