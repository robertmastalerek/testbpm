...
public class VariableApiTest {
  ...
  public void testTransientVariables() throws URISyntaxException {
    VariableMap variableMap = createVariables().putValueTyped("foo", doubleValue(10.0, true))
                     ...
                     .putValueTyped("blob", fileValue(new File(this.getClass().getClassLoader().getResource("org/eximeebpms/bpm/engine/test/variables/simpleFile.txt").toURI()), true))
                     ...
                     .putValueTyped("file", fileValue("org/eximeebpms/bpm/engine/test/variables/simpleFile.txt").setTransient(true).create())
  ...
  public void testTransientVariablesRaw() throws URISyntaxException {
    VariableMap variableMap = createVariables().putValueTyped("foo", doubleValue(10.0, true))
                     ...
                     .putValue("blob", fileValue(new File(this.getClass().getClassLoader().getResource("org/eximeebpms/bpm/engine/test/variables/simpleFile.txt").toURI()), true))
                     ...
                     .putValue("file", fileValue("org/eximeebpms/bpm/engine/test/variables/simpleFile.txt").setTransient(true).create())
