...
import org.eximeebpms.bpm.dmn.engine.impl.DefaultDmnEngine;
...
import org.eximeebpms.bpm.dmn.engine.impl.metrics.DefaultEngineMetricCollector;
...
import org.eximeebpms.bpm.dmn.engine.impl.transform.DefaultDmnTransformer;
...
import org.eximeebpms.bpm.dmn.feel.impl.juel.FeelEngineImpl;
...
public class DefaultDmnEngineConfigurationApiTest {
  ...
  public void shouldSetDefaultInputExpressionExpressionLanguage() {
    ...
    configuration.setDefaultInputExpressionExpressionLanguage("eximeebpms");
    assertThat(configuration.getDefaultInputExpressionExpressionLanguage())
      .isEqualTo("eximeebpms");
  }
  ...
  public void shouldSetFluentDefaultInputExpressionExpressionLanguage() {
    ...
    configuration.defaultInputExpressionExpressionLanguage("eximeebpms");
    assertThat(configuration.getDefaultInputExpressionExpressionLanguage())
      .isEqualTo("eximeebpms");
  }
  ...
  public void shouldSetDefaultInputEntryExpressionLanguage() {
    ...
    configuration.setDefaultInputEntryExpressionLanguage("eximeebpms");
    assertThat(configuration.getDefaultInputEntryExpressionLanguage())
      .isEqualTo("eximeebpms");
  }
  ...
  public void shouldSetFluentDefaultInputEntryExpressionLanguage() {
    ...
    configuration.defaultInputEntryExpressionLanguage("eximeebpms");
    assertThat(configuration.getDefaultInputEntryExpressionLanguage())
      .isEqualTo("eximeebpms");
  }
  ...
  public void shouldSetDefaultOutputEntryExpressionLanguage() {
    ...
    configuration.setDefaultOutputEntryExpressionLanguage("eximeebpms");
    assertThat(configuration.getDefaultOutputEntryExpressionLanguage())
      .isEqualTo("eximeebpms");
  }
  ...
  public void shouldSetFluentDefaultOutputEntryExpressionLanguage() {
    ...
    configuration.defaultOutputEntryExpressionLanguage("eximeebpms");
    assertThat(configuration.getDefaultOutputEntryExpressionLanguage())
      .isEqualTo("eximeebpms");
  }
  ...
  public void shouldSetDefaultLiteralExpressionLanguage() {
    ...
    configuration.setDefaultLiteralExpressionLanguage("eximeebpms");
    assertThat(configuration.getDefaultLiteralExpressionLanguage())
      .isEqualTo("eximeebpms");
  }
  ...
  public void shouldSetFluentDefaultLiteralExpressionLanguage() {
    ...
    configuration.defaultLiteralExpressionLanguage("eximeebpms");
    assertThat(configuration.getDefaultLiteralExpressionLanguage())
      .isEqualTo("eximeebpms");
  }
  ...
  public void shouldBeFluentConfigurable() {
    ...
    DmnEngine engine = configuration
      ...
      .defaultInputExpressionExpressionLanguage("eximeebpms")
      .defaultInputEntryExpressionLanguage("eximeebpms")
      .defaultOutputEntryExpressionLanguage("eximeebpms")
