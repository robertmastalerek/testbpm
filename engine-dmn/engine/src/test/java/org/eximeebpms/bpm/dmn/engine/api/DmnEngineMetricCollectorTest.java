...
public class DmnEngineMetricCollectorTest extends DmnEngineTest {
  ...
  public static final String DISH_EXAMPLE_DMN = "org/eximeebpms/bpm/dmn/engine/api/DrdDishDecisionExample.dmn";
  public static final String DRG_WITH_LITERAL_EXPRESSIONS = "org/eximeebpms/bpm/dmn/engine/api/DrgWithLiteralExpressions.dmn";
