 ...
 */
package org.eximeebpms.bpm.dmn.engine.delegate;
...
import org.eximeebpms.bpm.dmn.engine.impl.spi.hitpolicy.DmnHitPolicyHandler;
...
import org.eximeebpms.bpm.model.dmn.BuiltinAggregator;
...
public class DmnDecisionTableEvaluationListenerTest extends DmnEngineTest {
  ...
  public static final String DMN_FILE = "org/eximeebpms/bpm/dmn/engine/delegate/DmnDecisionTableListenerTest.test.dmn";
  ...
  public void testOutputs() {
    ...
    assertThat(output2.getValue()).isEqualTo(Variables.untypedValue("eximeebpms"));
