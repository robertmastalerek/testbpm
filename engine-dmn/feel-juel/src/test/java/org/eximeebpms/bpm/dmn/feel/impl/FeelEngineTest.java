 ...
 */
package org.eximeebpms.bpm.dmn.feel.impl;
...
import org.eximeebpms.bpm.dmn.feel.impl.juel.el.FeelFunctionMapper;
...
public class FeelEngineTest {
  ...
  public void testEndpointVariable() {
    ...
    variables.put("customer", Collections.singletonMap("name", "eximeebpms"));
    assertEvaluatesToTrue("eximeebpms", "customer.name");
  ...
  public void testPojo() {
    ...
    assertEvaluatesToFalse("eximeebpms", "pojo.foo");
