 ...
 */
package org.eximeebpms.bpm.container.impl.threading.ra;
...
import org.eximeebpms.bpm.container.impl.threading.ra.commonj.CommonJWorkManagerExecutorService;
import org.eximeebpms.bpm.container.impl.threading.ra.inflow.JobExecutionHandler;
import org.eximeebpms.bpm.container.impl.threading.ra.inflow.JobExecutionHandlerActivation;
import org.eximeebpms.bpm.container.impl.threading.ra.inflow.JobExecutionHandlerActivationSpec;
...
public class JcaExecutorServiceConnector implements ResourceAdapter, Serializable {
  ...
  public static final String ORG_CAMUNDA_BPM_ENGINE_PROCESS_ENGINE = "org.eximeebpms.bpm.engine.ProcessEngine";
  ...
  public class ExecutorServiceWrapper {
    /**
     * will hold a org.eximeebpms.bpm.container.ExecutorService reference
     */
  ...
  @ConfigProperty(
      type=String.class,
      defaultValue = "wm/eximeebpms-bpm-workmanager",
      description="Allows specifying the name of a CommonJ Workmanager."
  )
  protected String commonJWorkManagerName = "wm/eximeebpms-bpm-workmanager";
