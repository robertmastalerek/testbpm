...
public abstract class SoapHttpLogger extends BaseLogger {
  ...
  public static SoapHttpConnectorLogger SOAP_CONNECTOR_LOGGER = createLogger(SoapHttpConnectorLogger.class, PROJECT_CODE, "org.eximeebpms.bpm.connect.soap.httpclient.connector", "01");
