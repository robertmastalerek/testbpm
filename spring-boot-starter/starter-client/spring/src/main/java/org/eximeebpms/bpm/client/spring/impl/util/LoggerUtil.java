 ...
 */
package org.eximeebpms.bpm.client.spring.impl.util;

import org.eximeebpms.bpm.client.spring.impl.client.util.ClientLoggerUtil;
import org.eximeebpms.bpm.client.spring.impl.subscription.util.SubscriptionLoggerUtil;
...
public class LoggerUtil extends BaseLogger {
  ...
  protected static final String PROJECT_LOGGER = "org.eximeebpms.bpm.client.spring";
