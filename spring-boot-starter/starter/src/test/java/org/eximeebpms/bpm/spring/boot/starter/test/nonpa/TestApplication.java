 ...
 */
package org.eximeebpms.bpm.spring.boot.starter.test.nonpa;
...
public class TestApplication {
  ...
  @ConditionalOnProperty(prefix = "eximeebpms.bpm", name = "process-engine-name", havingValue = "nojpaTestEngine")
  @Configuration
