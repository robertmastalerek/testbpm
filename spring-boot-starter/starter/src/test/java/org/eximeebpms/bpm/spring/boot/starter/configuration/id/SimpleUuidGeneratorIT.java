...
import static org.eximeebpms.bpm.spring.boot.starter.configuration.id.IdGeneratorConfiguration.SIMPLE;

@RunWith(SpringRunner.class)
@SpringBootTest(classes = { TestApplication.class }, properties = "eximeebpms.bpm.id-generator=" + SIMPLE)
