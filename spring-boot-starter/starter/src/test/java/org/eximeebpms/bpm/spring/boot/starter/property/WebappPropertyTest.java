...
@TestPropertySource(properties = {
  "eximeebpms.bpm.webapp.indexRedirectEnabled=false",
  "eximeebpms.bpm.webapp.csrf.targetOrigin=localhost:8080",
  "eximeebpms.bpm.webapp.csrf.denyStatus=405",
  "eximeebpms.bpm.webapp.csrf.randomClass=java.util.Random",
  "eximeebpms.bpm.webapp.csrf.entryPoints[0]=/api/engine/engine/default/history/task/count",
  "eximeebpms.bpm.webapp.csrf.entryPoints[1]=/api/engine/engine/default/history/variable/count"
})
