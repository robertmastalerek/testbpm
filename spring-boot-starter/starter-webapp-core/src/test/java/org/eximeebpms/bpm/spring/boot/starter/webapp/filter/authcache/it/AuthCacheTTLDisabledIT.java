 ...
 */
package org.eximeebpms.bpm.spring.boot.starter.webapp.filter.authcache.it;
...
@TestPropertySource(properties = {
  "eximeebpms.bpm.admin-user.id=demo",
  "eximeebpms.bpm.admin-user.password=demo",
  "eximeebpms.bpm.webapp.auth.cache.ttl-enabled=false"
})
@DirtiesContext
public class AuthCacheTTLDisabledIT {
  ...
  public void shouldNotRemoveCache() {
    // given
    httpClientRule.performRequest("http://localhost:" + port + "/eximeebpms/app/welcome/default");
    ...
    httpClientRule.performPostRequest("http://localhost:" + port +
        "/eximeebpms/api/admin/auth/user/default/login/welcome", headers, "username=demo&password=demo");
  ...
  protected void doGetRequestToProfileEndpoint(Map<String, String> headers) {
    ...
    String profileEndpointPath = "/eximeebpms/api/engine/engine/default/user/demo/profile";
