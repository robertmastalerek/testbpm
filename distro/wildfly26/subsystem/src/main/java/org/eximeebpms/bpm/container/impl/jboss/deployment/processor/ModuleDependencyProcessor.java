...
public class ModuleDependencyProcessor implements DeploymentUnitProcessor {
  ...
  public static ModuleIdentifier MODULE_IDENTIFYER_PROCESS_ENGINE = ModuleIdentifier.create("org.eximeebpms.bpm.eximeebpms-engine");
  public static ModuleIdentifier MODULE_IDENTIFYER_XML_MODEL = ModuleIdentifier.create("org.eximeebpms.bpm.model.eximeebpms-xml-model");
  public static ModuleIdentifier MODULE_IDENTIFYER_BPMN_MODEL = ModuleIdentifier.create("org.eximeebpms.bpm.model.eximeebpms-bpmn-model");
  public static ModuleIdentifier MODULE_IDENTIFYER_CMMN_MODEL = ModuleIdentifier.create("org.eximeebpms.bpm.model.eximeebpms-cmmn-model");
  public static ModuleIdentifier MODULE_IDENTIFYER_DMN_MODEL = ModuleIdentifier.create("org.eximeebpms.bpm.model.eximeebpms-dmn-model");
  public static ModuleIdentifier MODULE_IDENTIFYER_SPIN = ModuleIdentifier.create("org.eximeebpms.spin.eximeebpms-spin-core");
  public static ModuleIdentifier MODULE_IDENTIFYER_CONNECT = ModuleIdentifier.create("org.eximeebpms.connect.eximeebpms-connect-core");
  public static ModuleIdentifier MODULE_IDENTIFYER_ENGINE_DMN = ModuleIdentifier.create("org.eximeebpms.bpm.dmn.eximeebpms-engine-dmn");
  public static ModuleIdentifier MODULE_IDENTIFYER_GRAAL_JS = ModuleIdentifier.create("org.graalvm.js.js-scriptengine");
  public static ModuleIdentifier MODULE_IDENTIFYER_JUEL = ModuleIdentifier.create("org.eximeebpms.bpm.juel.eximeebpms-juel");
