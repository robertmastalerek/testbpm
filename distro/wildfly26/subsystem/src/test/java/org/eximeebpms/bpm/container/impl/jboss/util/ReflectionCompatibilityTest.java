 ...
 */
package org.eximeebpms.bpm.container.impl.jboss.util;
...
/**
 * This class must be in package 'org.eximeebpms.bpm.container.impl.jboss.util' because of protected method test.
 */
public class ReflectionCompatibilityTest {
  ...
  public void reflectionAccessOnFieldValueTypesWorks() {
    ...
    StandardResourceDescriptionResolver testStandardResourceDescriptionResolver = new StandardResourceDescriptionResolver("eximeebpms-bpm-platform", BpmPlatformExtension.class.getPackage().getName() + ".TestLocalDescriptions", BpmPlatformExtension.class.getClassLoader());
