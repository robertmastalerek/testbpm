...
public class OneScopeTaskScenario {
  ...
  public static String deployProcess() {
    return "org/eximeebpms/bpm/qa/upgrade/task/oneScopeTaskProcess.bpmn20.xml";
  }

  @Deployment
  public static String deployNestedProcess() {
    return "org/eximeebpms/bpm/qa/upgrade/task/nestedOneScopeTaskProcess.bpmn20.xml";
  }
