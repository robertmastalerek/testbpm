 ...
 */
package org.eximeebpms.bpm.qa.upgrade.scenarios.job;
...
public class AsyncSequentialMultiInstanceScenario {
  ...
  public static String deployAsyncBeforeProcess() {
    return "org/eximeebpms/bpm/qa/upgrade/job/asyncBeforeSequentialMultiInstanceSubprocess.bpmn20.xml";
  }

  @Deployment
  public static String deployAsyncBeforeTask() {
    return "org/eximeebpms/bpm/qa/upgrade/job/asyncBeforeSequentialMultiInstanceTask.bpmn20.xml";
  }
