...
public class NonInterruptingBoundaryEventScenario {
  ...
  public static String deployTimerBoundary() {
    return "org/eximeebpms/bpm/qa/upgrade/boundary/nonInterruptingTimerBoundaryEvent.bpmn20.xml";
  }

  @Deployment
  public static String deployMessageBoundary() {
    return "org/eximeebpms/bpm/qa/upgrade/boundary/nonInterruptingMessageBoundaryEvent.bpmn20.xml";
  }
