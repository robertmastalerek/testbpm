...
public class AsyncParallelMultiInstanceScenario {
  ...
  public static String deployAsyncBeforeSubprocessProcess() {
    return "org/eximeebpms/bpm/qa/upgrade/job/asyncBeforeParallelMultiInstanceSubprocess.bpmn20.xml";
  }

  @Deployment
  public static String deployAsyncBeforeTaskProcess() {
    return "org/eximeebpms/bpm/qa/upgrade/job/asyncBeforeParallelMultiInstanceTask.bpmn20.xml";
  }
