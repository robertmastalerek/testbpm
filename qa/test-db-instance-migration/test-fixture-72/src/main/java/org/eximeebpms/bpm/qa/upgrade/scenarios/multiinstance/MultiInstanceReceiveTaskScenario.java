...
public class MultiInstanceReceiveTaskScenario {
  ...
  public static String deployProcessParallel() {
    return "org/eximeebpms/bpm/qa/upgrade/multiinstance/parallelMultiInstanceReceiveTask.bpmn20.xml";
  }

  @Deployment
  public static String deployProcessSequential() {
    return "org/eximeebpms/bpm/qa/upgrade/multiinstance/sequentialMultiInstanceReceiveTask.bpmn20.xml";
  }
