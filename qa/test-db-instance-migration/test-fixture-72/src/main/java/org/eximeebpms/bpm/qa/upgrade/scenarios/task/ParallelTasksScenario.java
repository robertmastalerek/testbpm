...
public class ParallelTasksScenario {
  ...
  public static String deployProcess() {
    return "org/eximeebpms/bpm/qa/upgrade/task/parallelTasksProcess.bpmn20.xml";
  }

  @Deployment
  public static String deployNestedProcess() {
    return "org/eximeebpms/bpm/qa/upgrade/task/nestedParallelTasksProcess.bpmn20.xml";
  }
