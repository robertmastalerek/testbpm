...
public class NestedNonInterruptingBoundaryEventOnOuterSubprocessScenario {
  ...
  public static String deployTimerBoundary() {
    return "org/eximeebpms/bpm/qa/upgrade/boundary/nestedNonInterruptingTimerBoundaryEventOnOuterSubprocess.bpmn20.xml";
  }

  @Deployment
  public static String deployMessageBoundary() {
    return "org/eximeebpms/bpm/qa/upgrade/boundary/nestedNonInterruptingMessageBoundaryEventOnOuterSubprocess.bpmn20.xml";
  }
