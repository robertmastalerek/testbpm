 ...
 */
package org.eximeebpms.bpm.qa.upgrade.scenarios.boundary;
...
public class NestedNonInterruptingBoundaryEventOnInnerSubprocessScenario {
  ...
  public static String deployTimerBoundary() {
    return "org/eximeebpms/bpm/qa/upgrade/boundary/nestedNonInterruptingTimerBoundaryEventOnInnerSubprocess.bpmn20.xml";
  }

  @Deployment
  public static String deployMessageBoundary() {
    return "org/eximeebpms/bpm/qa/upgrade/boundary/nestedNonInterruptingMessageBoundaryEventOnInnerSubprocess.bpmn20.xml";
  }
