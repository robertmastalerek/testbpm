    ...
    return new ScenarioSetup() {
      public void execute(ProcessEngine engine, String scenarioName) {
        ...
        String sourceProcessDefinitionId = engine.getRepositoryService().createDeployment()
          .addClasspathResource("org/eximeebpms/bpm/qa/upgrade/gson/oneTaskProcessMigrationV1.bpmn20.xml")
          .deployWithResult()
        ...
        String targetProcessDefinitionId = engine.getRepositoryService().createDeployment()
          .addClasspathResource("org/eximeebpms/bpm/qa/upgrade/gson/oneTaskProcessMigrationV2.bpmn20.xml")
          .deployWithResult()
          .getDeployedProcessDefinitions()
          .get(0)
          .getId();
