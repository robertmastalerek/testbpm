...
import org.eximeebpms.bpm.qa.upgrade.scenarios.compensation.InterruptingEventSubProcessNestedCompensationScenario;
import org.eximeebpms.bpm.qa.upgrade.scenarios.compensation.NestedCompensationScenario;
import org.eximeebpms.bpm.qa.upgrade.scenarios.compensation.NestedMultiInstanceCompensationScenario;
import org.eximeebpms.bpm.qa.upgrade.scenarios.compensation.NonInterruptingEventSubProcessCompensationScenario;
import org.eximeebpms.bpm.qa.upgrade.scenarios.compensation.ParallelMultiInstanceCompensationScenario;
import org.eximeebpms.bpm.qa.upgrade.scenarios.compensation.SequentialMultiInstanceCompensationScenario;
import org.eximeebpms.bpm.qa.upgrade.scenarios.compensation.SingleActivityCompensationScenario;
import org.eximeebpms.bpm.qa.upgrade.scenarios.compensation.SingleActivityConcurrentCompensationScenario;
import org.eximeebpms.bpm.qa.upgrade.scenarios.job.JobMigrationScenario;
import org.eximeebpms.bpm.qa.upgrade.scenarios.sentry.SentryScenario;
