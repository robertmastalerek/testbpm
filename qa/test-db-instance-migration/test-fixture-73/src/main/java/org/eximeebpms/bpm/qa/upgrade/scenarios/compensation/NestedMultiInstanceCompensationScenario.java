...
public class NestedMultiInstanceCompensationScenario {
  ...
  public static String deployThrowInnerProcess() {
    return "org/eximeebpms/bpm/qa/upgrade/compensation/nestedMultiInstanceCompensationThrowInnerProcess.bpmn20.xml";
  }

  @Deployment
  public static String deployThrowOuterProcess() {
    return "org/eximeebpms/bpm/qa/upgrade/compensation/nestedMultiInstanceCompensationThrowOuterProcess.bpmn20.xml";
  }
