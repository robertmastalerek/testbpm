 ...
 */
package org.eximeebpms.bpm.qa.upgrade.variables;
...
import org.eximeebpms.bpm.engine.impl.variable.serializer.jpa.EntityManagerSession;
import org.eximeebpms.bpm.engine.impl.variable.serializer.jpa.EntityManagerSessionFactory;
...
public class JpaVariableScenario {
  ...
  public static String deployOneTask() {
    return "org/eximeebpms/bpm/qa/upgrade/variables/JpaEntitiesScenario.oneTaskProcess.bpmn20.xml";
  }
