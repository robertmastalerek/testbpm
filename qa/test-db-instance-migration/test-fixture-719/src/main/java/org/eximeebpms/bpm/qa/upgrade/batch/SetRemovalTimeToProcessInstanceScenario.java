 ...
 */
package org.eximeebpms.bpm.qa.upgrade.batch;
...
public class SetRemovalTimeToProcessInstanceScenario {
  ...
  public static String deployOneTask() {
    return "org/eximeebpms/bpm/qa/upgrade/batch/SetRemovalTimeToProcessInstanceScenario.oneTaskProcess.bpmn20.xml";
  }
