 ...
 */
package org.eximeebpms.bpm.qa.upgrade.migration;
...
public class CreateSetVariablesMigrationBatchScenario {
  ...
  public static String sourceDeployment() {
    return "org/eximeebpms/bpm/qa/upgrade/migration/oneTaskProcess-source.bpmn20.xml";
  }

  @Deployment
  public static String targetDeployment() {
    return "org/eximeebpms/bpm/qa/upgrade/migration/oneTaskProcess-target.bpmn20.xml";
  }
