...
import org.eximeebpms.bpm.rest.beans.CustomProcessEngineProvider;
import org.eximeebpms.bpm.rest.beans.CustomRestApplication;
...
public class EmbeddedEngineRest_WILDFLY {
  ...
  public static WebArchive createDeployment() {
    ...
    WebArchive archive = ShrinkWrap.create(WebArchive.class, "embedded-engine-rest.war")
        ...
        .addAsManifestResource("org.eximeebpms.bpm.engine.rest.spi.ProcessEngineProvider", "META-INF/services/org.eximeebpms.bpm.engine.rest.spi.ProcessEngineProvider")
  ...
  private static JavaArchive[] getEngineRestClasses() {
    String coordinates = "org.eximeebpms.bpm:eximeebpms-engine-rest:jar:classes:" + System.getProperty("projectversion");
