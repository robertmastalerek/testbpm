...
import org.eximeebpms.bpm.integrationtest.functional.cdi.beans.ConditionalFlowBean;
import org.eximeebpms.bpm.integrationtest.functional.cdi.beans.ProcessVariableBean;
...
public class CdiBeanCallActivityResolutionTest extends AbstractFoxPlatformIntegrationTest {
  ...
  public static WebArchive createCallingProcessDeployment() {
    return initWebArchiveDeployment("pa1.war")
            ...
            .addAsResource("org/eximeebpms/bpm/integrationtest/functional/cdi/CdiBeanCallActivityResolutionTest.callingProcess.bpmn20.xml")
            .addAsResource("org/eximeebpms/bpm/integrationtest/functional/cdi/CdiBeanCallActivityResolutionTest.callingProcessConditionalFlow.bpmn20.xml");
  ...
  public static WebArchive createCalledProcessDeployment() {
    return initWebArchiveDeployment("pa2.war")
            ...
            .addAsResource("org/eximeebpms/bpm/integrationtest/functional/cdi/CdiBeanCallActivityResolutionTest.calledProcess.bpmn20.xml");
  }
