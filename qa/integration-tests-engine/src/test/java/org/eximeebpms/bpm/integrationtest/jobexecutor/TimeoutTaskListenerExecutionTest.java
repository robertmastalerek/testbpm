...
import org.eximeebpms.bpm.integrationtest.jobexecutor.beans.SampleTaskListenerBean;
...
public class TimeoutTaskListenerExecutionTest extends AbstractFoxPlatformIntegrationTest {
  ...
  public static WebArchive processArchive() {
    WebArchive archive = initWebArchiveDeployment()
            .addAsResource("org/eximeebpms/bpm/integrationtest/jobexecutor/TimeoutTaskListenerExecution.bpmn20.xml")
