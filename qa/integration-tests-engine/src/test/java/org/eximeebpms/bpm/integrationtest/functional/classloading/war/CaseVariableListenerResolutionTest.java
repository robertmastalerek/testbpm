...
import org.eximeebpms.bpm.integrationtest.functional.classloading.beans.ExampleCaseVariableListener;
...
public class CaseVariableListenerResolutionTest extends AbstractFoxPlatformIntegrationTest {
  ...
  public static WebArchive createProcessArchiveDeplyoment() {
    return initWebArchiveDeployment()
            ...
            .addAsResource("org/eximeebpms/bpm/integrationtest/functional/classloading/CaseVariableListenerResolutionTest.cmmn");
  }
  ...
  public void testResolveCaseExecutionListenerClass() {
    ...
    try {
      Class.forName("org.eximeebpms.bpm.integrationtest.functional.classloading.beans.ExampleCaseVariableListener");
