...
import org.eximeebpms.bpm.integrationtest.functional.classloading.beans.ExampleTaskListener;
...
public class TaskListenerResolutionTest extends AbstractFoxPlatformIntegrationTest {
  ...
  public static WebArchive createProcessArchiveDeplyoment() {
    return initWebArchiveDeployment()
            ...
            .addAsResource("org/eximeebpms/bpm/integrationtest/functional/classloading/TaskListenerResolutionTest.bpmn20.xml");
  }
  ...
  public void testResolveClassOnTaskComplete() {
    ...
    try {
      Class.forName("org.eximeebpms.bpm.integrationtest.functional.classloading.beans.ExampleTaskListener");
