 ...
 */
package org.eximeebpms.bpm.integrationtest.functional.condition;
...
import org.eximeebpms.bpm.integrationtest.functional.condition.bean.ConditionalBean;
...
public class ConditionalStartEventTest extends AbstractFoxPlatformIntegrationTest {
  ...
  public static WebArchive createProcessArchiveDeployment() {
    return initWebArchiveDeployment()
      ...
      .addAsResource("org/eximeebpms/bpm/integrationtest/functional/condition/ConditionalStartEventTest.bpmn20.xml");
  }
