...
import org.eximeebpms.bpm.integrationtest.jobexecutor.beans.SampleServiceBean;
...
public class TimerExecutionTest extends AbstractFoxPlatformIntegrationTest {
  ...
  public static WebArchive processArchive() {
    WebArchive archive = initWebArchiveDeployment()
            .addAsResource("org/eximeebpms/bpm/integrationtest/jobexecutor/TimerExecution.bpmn20.xml")
