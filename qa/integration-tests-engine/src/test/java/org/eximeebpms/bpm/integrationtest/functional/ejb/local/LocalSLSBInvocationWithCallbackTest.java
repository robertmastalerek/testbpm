 ...
 */
package org.eximeebpms.bpm.integrationtest.functional.ejb.local;

import org.eximeebpms.bpm.engine.runtime.ProcessInstance;
import org.eximeebpms.bpm.integrationtest.functional.ejb.local.bean.CallbackBean;
import org.eximeebpms.bpm.integrationtest.functional.ejb.local.bean.InvokeStartProcessDelegateSLSB;
import org.eximeebpms.bpm.integrationtest.functional.ejb.local.bean.StartProcessInterface;
import org.eximeebpms.bpm.integrationtest.functional.ejb.local.bean.StartProcessSLSB;
...
public class LocalSLSBInvocationWithCallbackTest extends AbstractFoxPlatformIntegrationTest {
  ...
  public static WebArchive processArchive() {
    return initWebArchiveDeployment()
      ...
      .addAsResource("org/eximeebpms/bpm/integrationtest/functional/ejb/local/LocalSLSBInvocationTest.testStartProcess.bpmn20.xml")
      .addAsResource("org/eximeebpms/bpm/integrationtest/functional/ejb/local/LocalSLSBInvocationTest.callbackProcess.bpmn20.xml")
      .addAsWebInfResource("org/eximeebpms/bpm/integrationtest/functional/ejb/local/jboss-deployment-structure.xml","jboss-deployment-structure.xml");
  }
  ...
  public static WebArchive delegateDeployment() {
    WebArchive webArchive = ShrinkWrap.create(WebArchive.class, "service.war")
      ...
      .addAsManifestResource(new StringAsset("Dependencies: org.eximeebpms.bpm.eximeebpms-engine"), "MANIFEST.MF"); // get access to engine classes
