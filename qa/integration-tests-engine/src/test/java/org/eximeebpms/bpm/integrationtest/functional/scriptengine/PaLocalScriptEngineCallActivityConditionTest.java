...
import org.eximeebpms.bpm.integrationtest.functional.scriptengine.engine.AbstractScriptEngineFactory;
import org.eximeebpms.bpm.integrationtest.functional.scriptengine.engine.AlwaysTrueScriptEngineFactory;
...
public class PaLocalScriptEngineCallActivityConditionTest extends AbstractFoxPlatformIntegrationTest {
  ...
  public static WebArchive createCallingProcessDeployment() {
    return initWebArchiveDeployment("pa1.war")
      ...
      .addAsResource("org/eximeebpms/bpm/integrationtest/functional/scriptengine/PaLocalScriptEngineCallActivityConditionTest.callingProcessScriptConditionalFlow.bpmn20.xml");
  }

  @Deployment(name="pa2")
  public static WebArchive createCalledProcessDeployment() {
    return initWebArchiveDeployment("pa2.war")
      .addAsResource("org/eximeebpms/bpm/integrationtest/functional/scriptengine/PaLocalScriptEngineCallActivityConditionTest.calledProcess.bpmn20.xml");
  }
