...
import org.eximeebpms.bpm.integrationtest.functional.ejb.local.bean.LocalSLSBClientDelegateBean;
import org.eximeebpms.bpm.integrationtest.functional.ejb.local.bean.LocalSLSBean;
...
public class LocalSLSBInvocationTest extends AbstractFoxPlatformIntegrationTest {
  ...
  public static WebArchive processArchive() {
    return initWebArchiveDeployment()
      ...
      .addAsResource("org/eximeebpms/bpm/integrationtest/functional/ejb/local/LocalSLSBInvocationTest.testInvokeBean.bpmn20.xml")
