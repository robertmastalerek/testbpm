...
import org.eximeebpms.bpm.integrationtest.functional.cdi.beans.CaseVariableBean;
...
public class CdiBeanCaseTaskResolutionTest extends AbstractFoxPlatformIntegrationTest {
  ...
  public static WebArchive createCallingProcessDeployment() {
    return initWebArchiveDeployment("pa1.war")
            .addAsResource("org/eximeebpms/bpm/integrationtest/functional/cdi/CdiBeanCallActivityResolutionTest.callingCase.cmmn");
  }
  ...
  public static WebArchive createCalledProcessDeployment() {
    return initWebArchiveDeployment("pa2.war")
            ...
            .addAsResource("org/eximeebpms/bpm/integrationtest/functional/cdi/CdiBeanCallActivityResolutionTest.calledCase.cmmn");
  }
