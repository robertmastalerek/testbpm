...
public class CaseExecutionListenerResolutionTest extends AbstractFoxPlatformIntegrationTest {
  ...
  public static WebArchive createProcessArchiveDeplyoment() {
    return initWebArchiveDeployment()
            ...
            .addAsResource("org/eximeebpms/bpm/integrationtest/functional/classloading/CaseExecutionListenerResolutionTest.cmmn");
  }
  ...
  public void testResolveCaseExecutionListenerClass() {
    ...
    try {
      Class.forName("org.eximeebpms.bpm.integrationtest.functional.classloading.beans.ExampleCaseExecutionListener");
