...
public class TestAdditionalResourceSuffixes extends AbstractFoxPlatformIntegrationTest {
  ...
  public static WebArchive processArchive() {
    ...
    WebArchive archive = ShrinkWrap.create(WebArchive.class, "test.war")
        ...
        .addAsResource("org/eximeebpms/bpm/integrationtest/deployment/cfg/processes-additional-resource-suffixes.xml", "META-INF/processes.xml")
        ...
        .addAsResource("org/eximeebpms/bpm/integrationtest/deployment/cfg/hello.groovy")
        .addAsResource("org/eximeebpms/bpm/integrationtest/deployment/cfg/hello.py");
