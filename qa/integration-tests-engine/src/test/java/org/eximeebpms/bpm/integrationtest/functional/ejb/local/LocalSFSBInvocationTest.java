...
import org.eximeebpms.bpm.integrationtest.functional.ejb.local.bean.LocalSFSBClientDelegateBean;
import org.eximeebpms.bpm.integrationtest.functional.ejb.local.bean.LocalSFSBean;
...
public class LocalSFSBInvocationTest extends AbstractFoxPlatformIntegrationTest {
  ...
  public static WebArchive processArchive() {
    return initWebArchiveDeployment()
      ...
      .addAsResource("org/eximeebpms/bpm/integrationtest/functional/ejb/local/LocalSFSBInvocationTest.testInvokeBean.bpmn20.xml")
