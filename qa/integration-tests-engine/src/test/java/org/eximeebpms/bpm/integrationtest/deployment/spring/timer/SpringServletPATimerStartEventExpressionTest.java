...
public class SpringServletPATimerStartEventExpressionTest extends AbstractFoxPlatformIntegrationTest {
  ...
  public static WebArchive processArchive() {
    return ShrinkWrap.create(WebArchive.class, "test.war")
      ...
      .addAsResource("org/eximeebpms/bpm/integrationtest/deployment/spring/timer/timer-start-event-process.bpmn", "timer-start-event-process.bpmn")
      .addAsWebInfResource("org/eximeebpms/bpm/integrationtest/deployment/spring/timer/start-event-expression-web.xml", "web.xml")
