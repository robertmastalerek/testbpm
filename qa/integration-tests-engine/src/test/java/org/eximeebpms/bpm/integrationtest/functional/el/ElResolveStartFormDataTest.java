...
import org.eximeebpms.bpm.integrationtest.functional.el.beans.ResolveFormDataBean;
...
public class ElResolveStartFormDataTest extends AbstractFoxPlatformIntegrationTest {
  ...
  public static WebArchive processArchive() {
    return initWebArchiveDeployment()
      ...
      .addAsResource("org/eximeebpms/bpm/integrationtest/functional/el/elStartFormProcessWithFormData.bpmn20.xml");
  }
