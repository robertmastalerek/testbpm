...
import org.eximeebpms.bpm.integrationtest.functional.el.beans.GreeterBean;
...
public class DecisionContextSwitchTest extends AbstractFoxPlatformIntegrationTest {
  ...
  protected static final String DMN_RESOURCE_NAME = "org/eximeebpms/bpm/integrationtest/functional/el/BeanResolvingDecision.dmn11.xml";
  ...
  public static WebArchive createBpmnDeployment() {
    return initWebArchiveDeployment("bpmn-deployment.war")
      .addAsResource("org/eximeebpms/bpm/integrationtest/functional/el/BusinessRuleProcess.bpmn20.xml");
  }
  ...
  public void shouldSwitchContextWhenUsingDecisionServiceAfterRedeployment() {
    ...
    // given
    List<org.eximeebpms.bpm.engine.repository.Deployment> deployments = repositoryService.createDeploymentQuery()
        .list();

    // find dmn deployment
    org.eximeebpms.bpm.engine.repository.Deployment dmnDeployment = null;
