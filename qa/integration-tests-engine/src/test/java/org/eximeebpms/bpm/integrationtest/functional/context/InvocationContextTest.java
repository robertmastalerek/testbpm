...
import org.eximeebpms.bpm.integrationtest.functional.context.beans.NoOpJavaDelegate;
import org.eximeebpms.bpm.integrationtest.functional.context.beans.SignalableTask;
...
public class InvocationContextTest extends AbstractFoxPlatformIntegrationTest {
  ...
  public static WebArchive createDeployment() {
    return ShrinkWrap.create(WebArchive.class, "app.war")
        ...
        .addAsResource("org/eximeebpms/bpm/integrationtest/functional/context/InvocationContextTest-timer.bpmn")
        .addAsResource("org/eximeebpms/bpm/integrationtest/functional/context/InvocationContextTest-message.bpmn")
        .addAsResource("org/eximeebpms/bpm/integrationtest/functional/context/InvocationContextTest-signalTask.bpmn");
  }
