...
import org.eximeebpms.bpm.integrationtest.functional.el.beans.ResolveExpressionBean;
...
public class ElResolverLookupTest extends AbstractFoxPlatformIntegrationTest {
  ...
  public static WebArchive processArchive() {
    return initWebArchiveDeployment()
      ...
      .addAsResource(
          "org/eximeebpms/bpm/integrationtest/functional/el/services/org.eximeebpms.bpm.application.ProcessApplicationElResolver",
          "META-INF/services/org.eximeebpms.bpm.application.ProcessApplicationElResolver")
      .addAsResource("org/eximeebpms/bpm/integrationtest/functional/el/elServiceTaskProcess.bpmn20.xml");
  }
