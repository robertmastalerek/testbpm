...
import org.eximeebpms.bpm.integrationtest.functional.ejb.remote.bean.RemoteSFSBClientDelegateBean;
import org.eximeebpms.bpm.integrationtest.functional.ejb.remote.bean.RemoteSFSBean;
...
public class RemoteSFSBInvocationTest extends AbstractFoxPlatformIntegrationTest {
  ...
  public static WebArchive processArchive() {
    return initWebArchiveDeployment()
      ...
      .addAsResource("org/eximeebpms/bpm/integrationtest/functional/ejb/remote/RemoteSFSBInvocationTest.testInvokeBean.bpmn20.xml");
  }
