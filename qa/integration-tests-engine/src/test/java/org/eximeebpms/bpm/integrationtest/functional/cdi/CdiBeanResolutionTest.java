...
import org.eximeebpms.bpm.engine.cdi.CdiStandaloneProcessEngineConfiguration;
import org.eximeebpms.bpm.engine.cdi.impl.util.ProgrammaticBeanLookup;
import org.eximeebpms.bpm.integrationtest.functional.cdi.beans.ExampleBean;
...
public class CdiBeanResolutionTest extends AbstractFoxPlatformIntegrationTest {
  ...
  public static WebArchive processArchive() {
    return initWebArchiveDeployment()
            ...
            .addAsResource("org/eximeebpms/bpm/integrationtest/functional/cdi/CdiBeanResolutionTest.testResolveBean.bpmn20.xml")
            .addAsResource("org/eximeebpms/bpm/integrationtest/functional/cdi/CdiBeanResolutionTest.testResolveBeanFromJobExecutor.bpmn20.xml");
  }
