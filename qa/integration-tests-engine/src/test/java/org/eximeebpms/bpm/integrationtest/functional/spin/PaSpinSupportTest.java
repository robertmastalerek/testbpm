...
public class PaSpinSupportTest extends AbstractFoxPlatformIntegrationTest {
  ...
  public static WebArchive createDeployment() {
    return initWebArchiveDeployment()
        ...
        .addAsResource("org/eximeebpms/bpm/integrationtest/functional/spin/jackson146.json");
  }
  ...
  public void testJacksonBug146() {
    InputStream resourceAsStream = getClass().getClassLoader().getResourceAsStream("org/eximeebpms/bpm/integrationtest/functional/spin/jackson146.json");
