...
import org.eximeebpms.bpm.integrationtest.deployment.ear.beans.EeComponent;
...
public class TestFoxPlatformClientAsEjbModule_pasAsEjbModule extends AbstractFoxPlatformIntegrationTest {
   ...
   *        |-- org/eximeebpms/bpm/integrationtest/deployment/ear/paAsEjbModule-process.bpmn20.xml
   *
  ...
  public static EnterpriseArchive paAsEjbModule() throws Exception {
    ...
    JavaArchive processArchive1Jar = ShrinkWrap.create(JavaArchive.class, "pa.jar")
      ...
      .addAsResource("org/eximeebpms/bpm/integrationtest/deployment/ear/paAsEjbModule-process.bpmn20.xml")
      .addAsResource("org/eximeebpms/bpm/integrationtest/deployment/ear/paAsEjbModule-pa.xml", "META-INF/processes.xml");
