...
import org.eximeebpms.bpm.integrationtest.jobexecutor.beans.FailingSLSB;
...
public class FailedJobCommandTest extends AbstractFoxPlatformIntegrationTest {
  ...
  public static WebArchive createDeployment() {
    return initWebArchiveDeployment()
      ...
      .addAsResource("org/eximeebpms/bpm/integrationtest/jobexecutor/FailedJobCommandTest.bpmn20.xml");
