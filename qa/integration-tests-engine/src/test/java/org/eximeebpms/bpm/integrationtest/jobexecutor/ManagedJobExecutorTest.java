...
import org.eximeebpms.bpm.integrationtest.jobexecutor.beans.ManagedJobExecutorBean;
...
public class ManagedJobExecutorTest {
  ...
  public static WebArchive createDeployment() {
    WebArchive archive = ShrinkWrap.create(WebArchive.class, "test.war")
        ...
        .addAsResource("org/eximeebpms/bpm/integrationtest/jobexecutor/ManagedJobExecutorTest.testManagedExecutorUsed.bpmn20.xml");
  ...
  public void testManagedExecutorUsed() throws InterruptedException {
    org.eximeebpms.bpm.engine.repository.Deployment deployment = processEngine.getRepositoryService().createDeployment()
      .addClasspathResource("org/eximeebpms/bpm/integrationtest/jobexecutor/ManagedJobExecutorTest.testManagedExecutorUsed.bpmn20.xml")
      .deploy();
