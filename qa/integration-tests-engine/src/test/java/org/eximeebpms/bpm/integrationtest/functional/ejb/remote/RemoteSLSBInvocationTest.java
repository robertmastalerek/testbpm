...
import org.eximeebpms.bpm.integrationtest.functional.ejb.remote.bean.RemoteSLSBClientDelegateBean;
import org.eximeebpms.bpm.integrationtest.functional.ejb.remote.bean.RemoteSLSBean;
...
public class RemoteSLSBInvocationTest extends AbstractFoxPlatformIntegrationTest {
  ...
  public static WebArchive processArchive() {
    return initWebArchiveDeployment()
      ...
      .addAsResource("org/eximeebpms/bpm/integrationtest/functional/ejb/remote/RemoteSLSBInvocationTest.testInvokeBean.bpmn20.xml");
  }
