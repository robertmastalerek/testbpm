...
public class SpinClassloadingTest extends AbstractFoxPlatformIntegrationTest {
  ...
  public final static WebArchive createPaDeployment() {
    ...
    return initWebArchiveDeployment()
      .addAsResource("org/eximeebpms/bpm/integrationtest/functional/spin/SpinClassloadingTest.bpmn")
      ...
      createVariables()
        .putValueTyped("xmlSerializable",
            serializedObjectValue(serializedValue)
              ...
              .objectTypeName("org.eximeebpms.bpm.integrationtest.functional.spin.XmlSerializable")
            .create()));
