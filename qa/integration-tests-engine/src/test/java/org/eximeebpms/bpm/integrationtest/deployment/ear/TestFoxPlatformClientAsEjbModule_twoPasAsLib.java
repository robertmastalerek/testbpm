...
public class TestFoxPlatformClientAsEjbModule_twoPasAsLib extends AbstractFoxPlatformIntegrationTest {
   ...
   *          |-- org/eximeebpms/bpm/integrationtest/deployment/ear/process1.bpmn20.xml
   *        |-- processes2.jar
   *          |-- META-INF/processes.xml
   *          |-- org/eximeebpms/bpm/integrationtest/deployment/ear/process2.bpmn20.xml
   *
  ...
  public static EnterpriseArchive twoPasAsLib() {
    ...
    JavaArchive processArchive1Jar = ShrinkWrap.create(JavaArchive.class, "processes1.jar")
      .addAsResource("org/eximeebpms/bpm/integrationtest/deployment/ear/process1.bpmn20.xml")
      .addAsResource("org/eximeebpms/bpm/integrationtest/deployment/ear/pa1.xml", "META-INF/processes.xml");

    JavaArchive processArchive2Jar = ShrinkWrap.create(JavaArchive.class, "processes.jar")
      .addAsResource("org/eximeebpms/bpm/integrationtest/deployment/ear/process2.bpmn20.xml")
      .addAsResource("org/eximeebpms/bpm/integrationtest/deployment/ear/pa2.xml", "META-INF/processes.xml");
