...
import org.eximeebpms.bpm.integrationtest.jobexecutor.beans.PriorityBean;
...
public class JobPrioritizationFailureJavaSerializationTest extends AbstractFoxPlatformIntegrationTest {
  ...
  public static final String VARIABLE_CLASS_NAME = "org.eximeebpms.bpm.integrationtest.jobexecutor.beans.PriorityBean";
  ...
  public static WebArchive createDeployment() {
    final WebArchive webArchive = initWebArchiveDeployment("paJavaSerialization1.war", "org/eximeebpms/bpm/integrationtest/processes-javaSerializationEnabled-pa1.xml")
      .addClass(PriorityBean.class)
      .addAsResource("org/eximeebpms/bpm/integrationtest/jobexecutor/JobPrioritizationTest.priorityProcess.bpmn20.xml");
  ...
  public static WebArchive createDummyClientDeployment() {
    final WebArchive webArchive = initWebArchiveDeployment("paJavaSerialization2.war", "org/eximeebpms/bpm/integrationtest/processes-javaSerializationEnabled-pa2.xml")
