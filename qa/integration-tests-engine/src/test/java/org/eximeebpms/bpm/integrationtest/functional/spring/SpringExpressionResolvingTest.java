...
import org.eximeebpms.bpm.integrationtest.functional.spring.beans.ExampleBean;
...
public class SpringExpressionResolvingTest extends AbstractFoxPlatformIntegrationTest {
  ...
  public static WebArchive processArchive() {
    ...
    return ShrinkWrap.create(WebArchive.class, "test.war")
      ...
      .addAsResource("org/eximeebpms/bpm/integrationtest/functional/spring/SpringExpressionResolvingTest.testResolveBean.bpmn20.xml")
      .addAsResource("org/eximeebpms/bpm/integrationtest/functional/spring/SpringExpressionResolvingTest.testResolveBeanFromJobExecutor.bpmn20.xml")
      ...
      .addAsWebInfResource("org/eximeebpms/bpm/integrationtest/functional/spring/web.xml", "web.xml")

      // spring application context & libs
      .addAsWebInfResource("org/eximeebpms/bpm/integrationtest/functional/spring/SpringExpressionResolvingTest-context.xml", "applicationContext.xml")
      .addAsLibraries(DeploymentHelper.getEngineSpring())

      // adding module dependency on process engine module (jboss only)
      .addAsManifestResource("org/eximeebpms/bpm/integrationtest/functional/spring/jboss-deployment-structure.xml", "jboss-deployment-structure.xml");
  }
