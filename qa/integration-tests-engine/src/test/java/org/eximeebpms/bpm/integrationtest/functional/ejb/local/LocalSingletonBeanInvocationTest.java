...
import org.eximeebpms.bpm.integrationtest.functional.ejb.local.bean.BusinessInterface;
import org.eximeebpms.bpm.integrationtest.functional.ejb.local.bean.LocalSingletonBean;
import org.eximeebpms.bpm.integrationtest.functional.ejb.local.bean.LocalSingletonBeanClientDelegateBean;
...
public class LocalSingletonBeanInvocationTest extends AbstractFoxPlatformIntegrationTest {
  ...
  public static WebArchive processArchive() {
    return initWebArchiveDeployment()
      ...
      .addAsResource("org/eximeebpms/bpm/integrationtest/functional/ejb/local/LocalSingletonBeanInvocationTest.testInvokeBean.bpmn20.xml")
